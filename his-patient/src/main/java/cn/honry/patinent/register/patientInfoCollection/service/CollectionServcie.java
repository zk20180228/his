package cn.honry.patinent.register.patientInfoCollection.service;
...
public interface CollectionServcie extends BaseService<Patient> {
	 ...
	 *
	 */
	void saveOrUpdateCollection(Patient patient);
