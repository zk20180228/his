package cn.honry.mobile.adviceManage.service;
...
public interface AdviceManageService extends BaseService<MAdviceManage>{
	 ...
	 * @ModifyRmk:  
	 * @version: V1.0
	 * @param:userStr 用户账号及姓名
	 * @throws:
	 * @return: 
	 *
	 */
	void saveAdviceManage(String userStr);
