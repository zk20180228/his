package cn.honry.mobile.mobileBlackList.service;
...
public interface MobileBlackListService  extends BaseService<MMobileBlackList> {
	 ...
	 *
	 */
	void save(MMobileBlackList mobileBlackList) throws Exception ;
	 ...
	 *
	 */
	void delCellPhoneBlack(String ids) throws Exception ;
