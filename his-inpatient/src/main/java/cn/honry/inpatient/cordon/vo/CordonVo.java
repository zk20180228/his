package cn.honry.inpatient.cordon.vo;
 ...
 * @author  lyy
 * @param 参数
 * @createDate： 2015年12月15日 下午2:52:29 
 * @modifier lyy
 * @modifyDate：2015年12月15日 下午2:52:29  
 * @modifyRmk：  
 * @version 1.0
 * @return
 * @throws Exception
 */
public class CordonVo  extends Entity{
	...
	private Double prepay;   //计算预交金金额
	private Double balance;   //余额=总钱数-花费总额
