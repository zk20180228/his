package cn.honry.inpatient.warnLine.vo;
...
public class WarnLineVo extends Entity{
	...
	/** 新添加字段 病历号  **/
	private String accountMedicalrecordId;
	/** 新添加字段   门诊金额  **/
	...
	public String getAccountMedicalrecordId() {
		return accountMedicalrecordId;
	}
	public void setAccountMedicalrecordId(String accountMedicalrecordId) {
		this.accountMedicalrecordId = accountMedicalrecordId;
	}
