package cn.honry.inpatient.docAdvManage.service;
...
public interface DocAdvManageService extends BaseService<InpatientOrder>{
	/**  
	 *  
	 * @Description： 查询医嘱资料
	 * @Author：yeguanqun
	 ...
	 *
	 */
	public Map<String,Object> saveOrUpdateInpatientOrder(InpatientOrderNow inpatientOrder,String str) throws Exception;
	/**  
	 *  
	 * @Description： 查询附材资料
	 * @Author：yeguanqun
