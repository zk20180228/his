package cn.honry.outpatient.cpway.dao;
...
public interface CPWayDao {
	 ...
	 * @throws:
	 */
	void approveApply(String cPWAppId, CPWayVo vo);
	 ...
	 * <p>根据科室编号查询院区编号 </p>
	 * @Author: zhangkui
	 * @CreateDate: 2017年12月26日 上午8:50:09 
	 * @Modifier: zhangkui
	 * @ModifyDate: 2017年12月26日 上午8:50:09 
	 * @ModifyRmk:  
	 * @version: V1.0
	 * @param deptCode
	 * @return
	 ...
	 * <p>获得住院流水号 </p>
	 * @Author: zhangkui
	 * @CreateDate: 2017年12月26日 上午9:16:29 
	 * @Modifier: zhangkui
	 * @ModifyDate: 2017年12月26日 上午9:16:29 
	 * @ModifyRmk:  
	 * @version: V1.0
	 * @return
	 * @throws:
