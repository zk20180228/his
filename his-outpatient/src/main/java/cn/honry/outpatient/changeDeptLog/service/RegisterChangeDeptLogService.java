package cn.honry.outpatient.changeDeptLog.service;
...
public interface RegisterChangeDeptLogService extends BaseService<RegisterChangeDeptLog>{
	 ...
	 *
	 */
	RegisterGrade findRegisterGrade(String gradeId);
	/**  
	 *  
