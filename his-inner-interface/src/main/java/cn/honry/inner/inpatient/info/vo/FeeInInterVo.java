...
*/	  private String packageCode;//组套代码                
	  ...
	  private Integer itemFlag=0 ;//  0非药品 2物资  
	  ...
	  private String oldRecipeNo;//原处方号和处方流水号
	  
	  /* 2017-02-23新添加字段 lys*/
	  private Integer feeFlag=0;//收费标志(0-划价;1-收费)
	  
	  private double totCost=0;//该项目的费用
	  private double ownCost=0;//自费金额
	  private double pubCost=0;//公费金额
	  private String nurseCellName;//护士站名称
	  private String medicalteamCode;//医疗组信息
	  private InpatientInfoNow inpatient;
	  ...
	  private Double retailprice;//单价
	  private String undrugEquipmentno;//设备号
	  private String minunitFlag; //开立单位是否是最小单位 1包装单位  2最小单位
	...
	public InpatientInfoNow getInpatient() {
		return inpatient;
	}
	public void setInpatient(InpatientInfoNow inpatient) {
