...
public class InpatientOrderInInterVO extends Entity {
	/**
	 * 
	 */
	...
	/**检查部位检体*/
	 ...
	 /**发药标记:0不需发送/1集中发送/2分散发送/3已配药*/
	 private String  drugedFlag;
	 
	 /**自制标识     1国产2进口3自制4合资*/ 
	 private Integer homeMadeFlag;   
	 /**医嘱原始状态*/
	 private Integer tempMoState;     
	 /**临时计价单位*/
	...
	public void setTempMoState(Integer tempMoState) {
		this.tempMoState = tempMoState;
	}
