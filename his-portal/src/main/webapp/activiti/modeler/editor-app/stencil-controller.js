...
angular.module('activitiModeler')
    .controller('StencilController', ['$rootScope', '$scope', '$http', '$modal', '$timeout', 'fromInfoService', function ($rootScope, $scope, $http, $modal, $timeout,fromInfoService) {
                ...
                if (shapes && shapes.length > 0) {
                    ...
                    for (var i = 0; i < properties.length; i++) {
                        ...
                        if (propertyConfig === undefined || propertyConfig === null) {
                            ...
                            //自定义表单限制 aizhonghau 2017-07-24
                            if('zkhonry-extend-frominfo-combobox'==currentProperty.type){
                            	fromInfoService.setValue(currentProperty.value);
                            }
