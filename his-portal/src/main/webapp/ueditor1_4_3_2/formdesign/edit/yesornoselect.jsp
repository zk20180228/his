...
<head>
	...
	function fnAddComboTr(obj)
	{
		...
		new_td_node1.innerHTML = '<td><input type="text" name="text" value="'+obj.value+'" name="'+obj.name+'" placeholder="选项值" readonly="readonly"></td>';
...
<script type="text/javascript">
	var attrKind = 0;
	var oNode = null,thePlugins = 'yesornoselect';
	...
	dialog.onok = function (){
		...
		oNode.innerHTML = fnParseOptions(gName,0);
		var label = oNode.parentNode;
		//使用边界，防止用户删除了span标签
		var html = '{请选择'+gTitle+'<span leipiplugins="yesornoselect" title="'+gTitle+'" code="'+gCode+'" id="'+gId+
		'" name="leipiNewField" inputcode="'+gInputCode+'" displaytype="1" codetype="'+gCodetype+'" attrKind="0" prefix="'+gPrefix+
		'" suffix="'+gSuffix+'" notnullChecked="'+gNotnullChecked+'" attrtype="3"'+
