...
<script type="text/javascript">
	var attrKind = 0;
	var oNode = null,thePlugins = 'textarea',text;
	...
	window.onload = function() {
		...
		text = oNode.firstChild.nextSibling.innerHTML;
		//获取属性值
	...
	dialog.onok = function (){
		...
		'" suffix="'+gSuffix+'" notnullChecked="'+gNotnullChecked+'" attrtype="5"'+
		' mustSelectChecked="'+gMustSelectChecked+'" statflgChecked="'+gStatflgChecked+
		'" printflgChecked="'+gPrintflgChecked+'">'+gPrefix+'<textarea  id="'+gCode+'" placeholder="'+gTitle+'"value="'+value+'" readonly="readonly" >'+value+'</textarea>'+gSuffix+'</span>}';
