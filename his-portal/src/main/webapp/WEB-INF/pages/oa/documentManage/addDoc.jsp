		...
		<form id="editForm" enctype="multipart/form-data" method="post">
			<table class="honry-table" cellpadding="1" cellspacing="1" border="0px" style="width:100%;border-left:0;" data-options="border:false">
				<tr>
					...
					<td class="honry-info">
					<input id="docName" name="docName"  data-options="required:true" style="width:200px" missingMessage="请输入文档名称" class="easyui-textbox"/>
				</tr>
				<tr>
					<td class="honry-lable">所属范围</td>
					<td class="honry-info">
					<input class="easyui-combobox" style="width:200px"  name="deptType" value="个人"
				...
				<tr>
					...
					<td class="honry-info">
					<textarea id="docDes" name="docDes"  rows="6" cols="50" ></textarea>
					</td>
				</tr>
			</table>
