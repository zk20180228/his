		...
		<form id="editForm" enctype="multipart/form-data" method="post">
			<table class="honry-table" cellpadding="1" cellspacing="1" border="0px" style="width:100%;border-left:0;" data-options="border:false">
				<tr>
					...
					<td class="honry-info">
					<input id="docName" name="fileNumber"  data-options="required:true" style="width:200px" missingMessage="请输入文档名称" class="easyui-textbox"/>
				</tr>
				<tr>
					<td class="honry-lable">档案名称</td>
					<td class="honry-info">
					<input id="docName" name="name"  data-options="required:true" style="width:200px" missingMessage="请输入文档名称" class="easyui-textbox"/>
				</tr>
				<tr>
					<td class="honry-lable">档案分类</td>
					<td class="honry-info">
					<input class="easyui-combobox" style="width:200px"  name="fileClassify" value="命令"
				...
				<tr>
					...
					<td class="honry-info">
					<input class="easyui-combobox" style="width:200px"  name="fileRank" value="普通"
				...
				<tr>
					...
					<td class="honry-info">
					<input class="easyui-combobox" style="width:200px"  name="fileType" value="文档"
				...
				<tr>
					...
					<td class="honry-info">
					<input class="easyui-combobox" style="width:200px"  name="fileStatus" value="编辑"
				...
				<tr id="trMan">
	    			...
	    			<td class="honry-info">
	    				<input class="easyui-combobox" id="fileMan" value="${fMan}"  name="fileMan" data-options="required:true" style="width:200px"/>
				...
				<tr id="trType">
		    			...
		    			<td class="honry-info">
		    				<input class="easyui-combobox" id="deptCode" value="${deptName}"  name="uploadDept" data-options="required:true" style="width:200px"/>
				...
				<tr>
					...
					<td class="honry-info">
					<input class="easyui-combobox" style="width:200px"  name="borrow" value="是"
