...
<body>
	...
	<script type="text/javascript">
	    ...
	    function getSelectionsIds(){
	    	...
	    	var sels = deleteBox.datagrid("getSelections");
	    	var ids = [];
	    	for(var i in sels){
	    		if(sels[i].id){
	    			ids.push(sels[i].id);
        ...
        $('#deleteBox').datagrid({
            fit:true,
            url:'<%=basePath%>oa/mail/queryBox.action?folder=4&cid=${id}',
            method:'get',
            singleSelect:false,
            fitColumns:true,
            pagination:true,
            ...
            toolbar: [{
                ...
                handler:function(){
                    ...
                    var row = $("#deleteBox").datagrid("getSelections")[0];
                    var subject;
                    if(row.subject != null){
                ...
                handler:function(){
                    var ids = [];
                    var rows = $("#deleteBox").datagrid("getSelections");
                    if(rows.length === 0){
                        $.messager.alert('提示','未选中任何邮件!');
                        return false;
                    }
