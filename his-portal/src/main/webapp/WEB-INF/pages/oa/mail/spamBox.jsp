...
<body>
	...
	<script type="text/javascript">
	    ...
	    function getSelectionsIds(){
	    	var spanBox = $("#spanBox");
	    	var sels = spanBox.datagrid("getSelections");
	    	var ids = [];
	    	for(var i in sels){
	    		if(sels[i].id){
	    			ids.push(sels[i].id);
        ...
        $('#spanBox').datagrid({
            fit:true,
            url:'<%=basePath%>oa/mail/queryBox.action?folder=5&cid=${id}',
            method:'get',
            singleSelect:false,
            fitColumns:true,
            pagination:true,
            ...
            toolbar: [{
                ...
                handler:function(){
                    ...
                    var row = $("#spanBox").datagrid("getSelections")[0];
                    var subject;
                    if(row.subject != null){
                ...
                handler:function(){
                    var ids = [];
                    var rows = $("#spanBox").datagrid("getSelections");
                    if(rows.length === 0){
                        $.messager.alert('提示','未选中任何邮件!');
                        return false;
                    }
