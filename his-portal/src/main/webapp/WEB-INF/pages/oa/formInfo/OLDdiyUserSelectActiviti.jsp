...
<html>
	...
	<body>
		<div class="contentnav">
			<h1 class="userSelectTitle">候选人</h1>
			<!-- 人员 -->
			<div class="topContent clearfix" style="padding-left: 20px;">
				<div class="treePanel panel panel-default ">
					<!--<div class="panel-heading">科室信息</div>-->
					<div class="panel-body">
						<div class="treeMain">
							<div class="treeBtnBox" style="line-height: 32px;height: 32px;padding-left: 5px;">
...
//				} else {
					...
					if(tmp) {
						$("#selectAll1").append("<option userName = '" + rowData.jobNo + "'>" + rowData.name + "</option>")
					}
//				}
			}
		});
...
//			}
			...
			for(var i = 0; i < data.length; i++) {
				tmp = true
				$('#selectAll1 option').each(function(index, v) {
					if(v.getAttribute("userName") == data[i]["jobNo"]) {
						tmp = false
						return false;
					}
				})
				if(tmp) {
					str += "<option userName='" + data[i]["jobNo"] + "'>" + data[i]["name"] + "</option>"
				}
			}
			if(str != "") {
