	...
	$(function(){
		...
		$('#tempList').datagrid({
			...
			onDblClickRow: function(rowIndex,rowData){
				$('iframe').attr('src','<%=basePath %>emrs/writeMedRecord/emrMainEdit.action?menuAlias=${menuAlias}&erType='+rowData.tempErtype+'&ids='+rowData.id+'&patId='+patId);
