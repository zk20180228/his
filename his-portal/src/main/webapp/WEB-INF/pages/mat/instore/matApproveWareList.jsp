	...
	<body>
					...
					<tr>
						<td style="padding: 5px 15px;" nowrap="nowrap" >
							...
							<input class="easyui-combobox" id="queryName" data-options="valueField: 'id', textField: 'value', 
								data: [{ id: '01', value: '一般入库'},{ id: '02', value: '发票入库' },{id: '03', value: '核准入库' ,selected:true },{id: '04', value: '入库退货' },
		...
		<div id="divLayout" class="easyui-layout" fit=true>
			...
			<div data-options="region:'west',split:false,title:'物资列表',iconCls:'icon-book'" style="padding: 5px; width: 35% ;">
				<table cellspacing="0" cellpadding="0" border="0">
					<tr>
						<td style="padding: 5px 15px;" nowrap="nowrap" >
							...
							至
							<input id="endTime" type="text" class="easyui-datebox" class="easyui-datetimebox" data-options="required:true,showSeconds:false" ></input> 
						</td>
						<td>
							&nbsp;&nbsp;
				...
				<table id="list" data-options="url:'<%=basePath%>material/instore/queryMatInput.action?flg=1',method:'post',rownumbers:true,idField: 'id',striped:true,border:true,checkOnSelect:true,selectOnCheck:true,singleSelect:true,fitColumns:false">
					<thead>
						<tr>
							<th data-options="field:'invoiceNo',width : '25%'">
								发票号
							</th>
							<th data-options="field:'invoiceDate',width : '12%'">
								发票日期
							</th>
							...
							<th data-options="field:'companyCode',width : '20%'">
								供货公司编码
							</th>
						</tr>
					</thead>
			...
			function save() {
				...
				if (rows.length > 0) {//选中几行的话触发事件	                        
					...
					$('#saveForm').form('submit',{
						url : "<%=basePath%>material/instore/editMatInput.action",
						onSubmit : function() {
