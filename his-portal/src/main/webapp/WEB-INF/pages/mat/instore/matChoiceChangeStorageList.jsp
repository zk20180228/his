	...
	<body>
						...
						<td style="padding: 5px 15px;" nowrap="nowrap" >
							...
							<input class="easyui-combobox" id="queryName" data-options="valueField: 'id', textField: 'value', 
								data: [{ id: '01', value: '一般入库'},{ id: '02', value: '发票入库' },{id: '03', value: '核准入库' },{id: '04', value: '入库退货' },
									   ...
									   {id: '08', value: '备货入库' },{id: '09', value: '备货退货'},{id: '10', value: '备货换货',selected:true},{id: '11', value: '特殊入库'},{id: '12', value: '特殊入库审核'}
		...
		<div id="divLayout" class="easyui-layout" fit=true>
			...
			<div data-options="region:'west',split:false,title:'物资列表',iconCls:'icon-book'" style="padding: 5px; width: 35% ;">
				...
				<table id="list" data-options="url:'<%=basePath%>material/instore/queryStockDetailVir.action',method:'post',rownumbers:true,idField: 'id',striped:true,border:true,checkOnSelect:true,selectOnCheck:true,singleSelect:true,fitColumns:false">
					<thead>
						<tr>
							...
							<th data-options="field:'storeNum',width : '12%'">
								库存数量
							</th>
							...
							<th data-options="field:'highvalueBarcode',width : '15%'">
								高值耗材条形码
							</th>
						</tr>
					</thead>
			...
			function save() {
				...
				if (rows.length > 0) {//选中几行的话触发事件	                        
					...
					$('#saveForm').form('submit',{
						url : "<%=basePath%>material/instore/changeMatChoice.action",
						onSubmit : function() {
