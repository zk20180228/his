					...
					<tr>
						<td style="padding: 5px 15px;" nowrap="nowrap" >
							...
							<input class="easyui-combobox" id="queryName" data-options="valueField: 'id', textField: 'value', 
								data: [{ id: '01', value: '一般入库' },{ id: '02', value: '发票入库' },{id: '03', value: '核准入库' },{id: '04', value: '入库退货' ,selected:true},
						...
						<td>
							&nbsp;&nbsp;
							供货公司：
							<input id="companyCode" style="width:180px"/>
						</td>
						<td>
							&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<div id="divLayout" class="easyui-layout" fit=true>
			...
			<div data-options="region:'west',split:false,title:'物资列表',iconCls:'icon-book'" style="padding: 5px; width: 35% ;">
				<table cellspacing="0" cellpadding="0" border="0">
					...
					<tr>
						<td style="padding: 5px 15px;" nowrap="nowrap">
							状&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;态：<input id="inState" type="text" class="easyui-combobox" data-options="valueField: 'id', textField: 'value', 
				...
				<table id="list" data-options="url:'<%=basePath%>material/instore/queryMatInput.action',method:'post',rownumbers:true,idField: 'id',striped:true,border:true,checkOnSelect:true,selectOnCheck:true,singleSelect:true,fitColumns:false">
					<thead>
						<tr>
			...
			$(function() {
				...
				$('#list').datagrid({
					...
					onDblClickRow : function(rowIndex, rowData) {//双击赋值
						$('#infolist').edatagrid({
							url:"<%=basePath%>material/instore/queryStockDetail.action?stockCode="+rowData.stockCode
						});
			...
			function save() {
				...
				if (rows.length > 0) {//选中几行的话触发事件	                        
					...
					$('#saveForm').form('submit',{
						url : "<%=basePath%>material/instore/returnMatInput.action",
						onSubmit : function() {
