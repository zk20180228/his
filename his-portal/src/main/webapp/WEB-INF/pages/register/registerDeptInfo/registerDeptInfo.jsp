...
// 						$("body").rmoveLoading("body");
				...
				$('#roleMenuList').datagrid({
					url:'<%=basePath%>statistics/RegisterInfoGzltj/queryRegisterDeptInfo.action',
			queryParams:{
				sTime: Stime,
				eTime: Etime,
				dept: deptCodes,
					...
					<table  style="width: 100%;" id="roleMenuList">
						<thead>
							<tr>
								...
								<th data-options="field:'deptName',rowspan:2,sortable:true,align:'left'" width="10%">科室</th>
