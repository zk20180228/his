		...
		<div class="easyui-layout" data-options="fit:true">
			<div data-options="region:'center',split:true">
				<form id="editForm" method="post">
					<input id="inpatientNo" type="hidden" value="${emrFirst.inpatientNo}">
					<div>
			...
			<div data-options="region:'south',split:false" style="height:50px;">
				<div style="text-align: center; padding: 5px;">
					<a href="javascript:submitApply();void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-bullet_tick'">确定</a>
