...
<body>
		...
		<div id="t" data-options="region:'north'" style="width: 80%;height: 60%;">
			<div id="test" style="height: 95%">
				<form method="post" id="saveform" name="saveform" action="/index.php?s=/index/parse.html" >
					...
					<input type="hidden" id="advice" name="emrMain.emrHigherAdvice" value='${emrMain.emrHigherAdvice }'>
		...
		<div data-options="region:'center',border:false,title:'审签意见'" style="width: 80%;height: 35%;">
			<div class="easyui-layout" fit="true" data-options="border:false"> 
				<div style="height: 100;width: 100%;"  data-options="region:'center',border:false">
					<input id="vice" class="easyui-textbox" data-options="multiline:true" value='${emrMain.emrHigherAdvice }' style="width:100%;height: 100%"> 
				</div>
			</div>
		</div>
		<div id="adviceButton" data-options="region:'south'" style="width: 80%;height: 30px;text-align: center;">
			<a id="tick" href="javascript:void(0)" onclick="tick(2)" class="easyui-linkbutton" data-options="iconCls:'icon-tick',plain:true">通过</a>
	...
	var newContent = '';
	var dels = '<span style="text-decoration:line-through;border-bottom:1px double black;">';
	var dele = '</span>'
	var adds = '<span style="border-bottom:1px double black;">';
	var adde = '</span>'
	/**
	* 创建文本编辑器
	* @author  yeguanqun
