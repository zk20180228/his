	...
	$(function(){
		...
		$('#list').datagrid({
			...
			onDblClickRow: function (rowIndex, rowData) {//双击查看
				if(rowData.emrState == 3){
					$.messager.confirm('确认对话框', '此病历已审签，只可查看，是否查看？', function(r){
						if (r){
							window.open ('<%=basePath%>emrs/reviewEmrMain/toEmrChiefEditView.action?id=' + rowData.id,'newwindow',' left=400,top=200,width='+ (screen.availWidth -1000) +',height='+ (screen.availHeight-370) 
