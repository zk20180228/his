	...
	$(function(){
		...
		$('#list').datagrid({
			...
			onBeforeLoad:function(param){
				...
				if(param.patId == undefined && parent.window.getPaType() != ''){
					param.patId = parent.window.getPaType();
				}
				param.state = '0';
...
<body>
	<div class="easyui-layout" data-options="fit:true">
		<div id="divLhmMessage" data-options="region:'center',border:'true'"  fit=true style="border-top:0">
