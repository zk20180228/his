...
<body>
	<div id="divLayout2" class="easyui-layout" fit="true"> 
		<div id="t" data-options="region:'center'" style="width: 80%">
		...
		<div id="tt" data-options="region:'east'" style="width: 20%;height:100%;">
			<div id="ttt" class="easyui-tabs" data-options="fit:false,tabPosition:'bottom'" style="clear: both;height:100%;"> 
				<div title="工具箱" id="" style="padding: 5px 5px 5px 5px;height:95%;">   
					<div id="divLayout1" class="easyui-layout" fit=true> 				
						<div id="m"data-options="region:'north',title:'工具箱',split:true" style="width: 240px;height:58%;">
		    ...
		    content = strContent.replace(preg, function(plugin,p1,p2,p3,p4,p5,p6){
		        ...
		        if(tag == 'radios' || tag == 'checkboxs' || tag == 'yesornoselect')
		        {
		        	if(attrkind == 1){
			        	...
			        	return p1.replace(/(disabled="true")/gi,' ');
			        }
		        }
		       ...
		       if(tag == 'text'){
		           return p1.replace(' readonly="readonly"',' value="'+value+'" ');
		       }
		       if(tag == 'textarea'){
		    	   return p1.replace(' readonly="readonly">',' >'+value);
		       }
		       if(tag == 'number'){
		           return p1.replace(' readonly="readonly"',' value="'+value+'" ');
		       }
	...
	var templateDesign = {
			...
			fnReview : function (){
			    ...
			    if(templateEditor.hasContents()){
			        ...
			        document.saveform.action="<%=basePath%>emrs/writeMedRecord/toPreview.action";
