...
<body>
	<div class="content">
		<form id="editForm" method="post">
		    <input id="attrType" type="hidden" name="attr.attrType" value="1"/>
	...
	function submit(){ 
		...
		function sub(url) {
			$('#editForm').form('submit',{  
		        ...
		        success:function(data){  
		        	...
		        	if(data == 'error'){
						$.messager.alert("操作提示",'控件名称已存在，请修改！');	
						setTimeout(function(){$(".messager-body").window('close')},3500);
		        	}
		        },
				error : function(data) {
		...
		*/
		...
		function fnAddComboTr(obj)
		{
		    ...
		    new_td_node0.innerHTML = '<td><input type="radio" '+sChecked+' name="radio" ></td>';
