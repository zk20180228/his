		...
		<div style="padding:5px 5px 5px 5px;">
			...
			<table style="width: 70%;margin-left:auto;margin-right:auto;">
				<tr>
					...
					${maintenance.nurPatid }&nbsp;姓名：${maintenance.nurName }&nbsp;
					日期：
					<input type="text" id="dateboxs" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'%y-%M-%d',onpicked:pickedFunc})" value="${maintenance.nurMeasurEtime}" class="Wdate" style="width: 150px"/>
