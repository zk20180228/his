...
$(function (){
	...
	for(nurMeasur in nurMeasurModeList){
		if(nurMeasur == 1){
 ...
 */
function clear(){
	window.location.href="<%=basePath%>emrs/maintenance/toViewMaintenanceList.action?menuAlias=${menuAlias}&nurInpatientNo="+'${maintenance.nurPatid}';
}
</script>
</head>
<body>
	...
	<div style="padding:5px 5px 5px 5px;">
		<table style="width:100%;border:1px solid #95b8e7;padding:5px;">
			<tr>
				...
				<td style="padding: 5px 15px;font-size:14px" >${maintenance.nurPatid }</td>
				...
				<td style="padding: 5px 15px;font-size:14px" ><input id="dateboxs" type="text" class="easyui-datebox" value="${maintenance.infoDate}"></input></td>
			</tr>
		</table>   
	</div>
	<div style="padding:5px 5px 5px 5px;">
