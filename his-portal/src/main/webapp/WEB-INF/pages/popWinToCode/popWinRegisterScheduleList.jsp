			...
			<div data-options="region:'center',fit:true"  id="content" style="width: 100%">
				...
				<div style="padding: 0px 5px 5px 5px;height: 90%">
					<table id="list" style="width:100%" data-options="fit:true">
						<thead>
							<tr>
			    				<th data-options="field:'name'" style="width:100%">姓名</th>
	...
	//加载页面
		$(function(){
			...
			$('#list').datagrid({
				...
				singleSelect:true,
				pagination:true,
				url:'queryRegisterSchedulePopWin.action',
				method:'post',
				rownumbers:true,
				idField: 'id',
				striped:true,
		...
		*/
		function searchFrom(){ 
	   		...
	   		$('#list').datagrid({
				url:'<%=basePath%>/popWin/popWinRegisterSchedule/queryRegisterSchedulePopWin.action',
				method:'post',
				checkOnSelect:true,
				selectOnCheck:false,
				singleSelect:true,
