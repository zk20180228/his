					...
					<table id="list" style="width:100%" data-options="fit:true">
						<thead>
							<tr>
			    				...
			    				<th data-options="field:'companyName'" style="width:40%">名称</th>
			    				<th data-options="field:'companyPinyin'" style="width:20%">拼音码</th>
			    				<th data-options="field:'companyWb'" style="width:25%">五笔码</th>
			    				<th data-options="field:'companyInputcode'" style="width:20%">自定义码</th>
	...
	//加载页面
		$(function(){
			...
			$('#list').datagrid({
				...
				selectOnCheck:false,
				singleSelect:true,
				url:'querySupplycompanyPopWin.action',
				method:'post',
				rownumbers:true,
				idField: 'id',
				striped:true,
		...
		*/
		function searchFrom(){ 
	   		...
	   		$('#list').datagrid({
				url:'<%=basePath%>popWin/popWinSupplyCompany/querySupplycompanyPopWin.action',
				method:'post',
				checkOnSelect:true,
				selectOnCheck:false,
				singleSelect:true,
