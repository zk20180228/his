			...
			<div data-options="region:'center',fit:true"  id="content" style="width: 100%">
				...
				<div style="padding: 0px 5px 5px 5px;height: 90%">
					<table id="list" style="width:100%" data-options="fit:true">
						<thead>
							<tr>
			    				<th data-options="field:'mfName'" style="width:35%">名称</th>
			    				<th data-options="field:'mfAlias'" style="width:30%">别名</th>
			    				<th data-options="field:'mfDescription'" style="width:35%">说明</th>
	...
	//加载页面
		$(function(){
			...
			$('#list').datagrid({
				...
				selectOnCheck:false,
				singleSelect:true,
				url:'queryMenuFunctionPopWin.action',
				method:'post',
				rownumbers:true,
				idField: 'id',
				striped:true,
				...
				$.each(rowData, function (index, value) {
	             ...
	             onDblClickRow: function (rowIndex, rowData) {//双击查看
			    		...
			    		var tmpId ="#"+textId;
			    		if('function' === typeof window.opener.popWinMenuFunctionBackFn){
							window.opener.popWinMenuFunctionBackFn(rowData);
						}else{
		...
		*/
		function searchFrom(){ 
	   		...
	   		$('#list').datagrid({
				url:'<%=basePath%>/popWin/popWinMenuFunction/queryMenuFunctionPopWin.action',
				method:'post',
				checkOnSelect:true,
				selectOnCheck:false,
				singleSelect:true,
