					...
					<table id="list" style="width:100%" data-options="fit:true">
						<thead>
							<tr>
			    				...
			    				<th data-options="field:'name'" style="width:24%">名称</th>
			    				<th data-options="field:'pinyin'" style="width:24%">拼音码</th>
			...
			$('#list').datagrid({
				...
				$.each(rowData, function (index, value) {
	             ...
	             onDblClickRow: function (rowIndex, rowData) {//双击查看
			    		...
			    		var tmpId ="#"+textId;
			    		if('function' === typeof window.opener.popWinEmpTitleBackFn){
