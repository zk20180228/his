	...
	<div class="easyui-layout" style="width:100%;height:100%;" id="treeLayOut">
		<div data-options="region:'center'"  id="content">
				...
				<div style="padding: 0px 5px 5px 5px;">
					<table id="list" style="width:100%" data-options="url:'queryBCUnit.action?nameTmp=${nameTmp}',method:'get',rownumbers:true,idField: 'id',striped:true,border:true,checkOnSelect:true,selectOnCheck:false,singleSelect:true,fitColumns:false">
						<thead>
							<tr>
			    				<th data-options="field:'encode'" style="width:20%">代码</th>
			    				<th data-options="field:'name'" style="width:20%">名称</th>
			    				<th data-options="field:'pinyin'" style="width:20%">拼音码</th>
			    				<th data-options="field:'wb'" style="width:20%">五笔码</th>
			    				<th data-options="field:'inputCode'" style="width:20%">自定义码</th>
							</tr>
						</thead>
					</table>
				</div>
	...
	<script type="text/javascript">
		...
		*/
		function searchFrom(){ 
	   		...
	   		$('#list').datagrid({
				url:'<%=basePath%>popWin/popWinUnit/queryBCUnit.action',
				method:'post',
				singleSelect:true,
				pagination:true,pageList:[20,30,50,80,100],pageSize:20,
				queryParams: {
