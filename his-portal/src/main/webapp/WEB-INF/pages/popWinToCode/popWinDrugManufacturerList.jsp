			...
			<div data-options="region:'center',fit:true"  id="content" style="width: 100%">
				...
				<div style="padding: 0px 5px 5px 5px;height: 90%">
					<table id="list" style="width:100%" data-options="fit:true">
						<thead>
							<tr>
			    				<th data-options="field:'manufacturerName'" style="width:40%">名称</th>
			    				<th data-options="field:'manufacturerPinyin'" style="width:20%">拼音码</th>
			    				<th data-options="field:'manufacturerWb'" style="width:20%">五笔码</th>
			    				<th data-options="field:'manufacturerInputcode'" style="width:20%">自定义码</th>
	...
	//加载页面
		$(function(){
			...
			$('#list').datagrid({
				...
				selectOnCheck:false,
				singleSelect:true,
				url:'queryDrugManufacturerPopWin.action',
				method:'post',
				rownumbers:true,
				idField: 'id',
				striped:true,
		...
		*/
		function searchFrom(){ 
	   		...
	   		$('#list').datagrid({
				url:'<%=basePath%>/popWin/popWinDrugManufacturer/queryDrugManufacturerPopWin.action',
				method:'post',
				checkOnSelect:true,
				selectOnCheck:false,
				singleSelect:true,
