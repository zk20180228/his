...
<body>
		...
		<div class="easyui-panel" data-options="title:'信息查询',iconCls:'icon-search'">
						<table cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td>&nbsp;&nbsp;&nbsp;&nbsp;
								搜索：
									<input type="text" ID="encode" name="codeTitle.encode" onkeydown="KeyDown()"/>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<table id="list" 
				data-options="method:'post',rownumbers:true,idField: 'id',striped:true,border:true,checkOnSelect:true,selectOnCheck:false,singleSelect:true,fitColumns:false">
				<thead>
					<tr>
	...
	function  queding(){
		if (getIdUtil("#list").length != 0) {
			...
			var level=user[2];
			//文本框赋值
			parent.document.getElementById("parent").value=parentd;
			parent.document.getElementById("parentId").value=parentId;
			parent.document.getElementById("levell").value=level;
			parent.document.getElementById("levell").value=level;
