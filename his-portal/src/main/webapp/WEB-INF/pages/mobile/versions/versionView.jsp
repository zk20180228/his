			...
			<table class="honry-table removeBorders"  cellpadding="0" cellspacing="0" border="0" style="width:100%">
				...
				<tr>
					...
					<td id="stopFlgTd"	class="honry-view">
						<input type="hidden" id="stopFlg" value="${mApkVersion.forceUpdateFlg }"/>
					</td>
				</tr>
				<tr>
					<td class="honry-lable">
					...
					<td id="apkClearCacheTd"	class="honry-view">
						<input type="hidden" id="apkClearCache" value="${mApkVersion.apkClearCache }"/>
					</td>
				</tr>
				<tr>
					<td class="honry-lable">
				...
				<tr>
					...
					<td class="honry-view">
						${mApkVersion.apkDownloadFixedAddr }&nbsp;
					</td>
				</tr>
