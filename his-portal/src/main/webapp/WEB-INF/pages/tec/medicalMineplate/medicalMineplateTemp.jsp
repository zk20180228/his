	...
	<div id="divLayout" class="easyui-layout" data-options="fit:true">
        <div data-options="region:'north',split:false" style="height:40px;padding:5px 5px 5px 5px;">	        
			<table cellspacing="0" cellpadding="0" border="0">
				<tr>
					<td style="padding: 5px 10px;">查询条件：</td>
					<td>
                	...
                	if (rows.length > 0) {//选中几行的话触发事件	 
                		$.messager.confirm('确认', '确定要导入选中信息吗?', function(res){
                			if (res){
								...
								$.ajax({
									url:"<%=basePath%>technical/medicalMineplate/MedicalmodelAddTemp.action?id="+ids+"&deptId="+deptId+"&nowWeek="+weeken+"&week="+$('#inpWeekId1').val(),
									type:'get',
									success: function(data) {
