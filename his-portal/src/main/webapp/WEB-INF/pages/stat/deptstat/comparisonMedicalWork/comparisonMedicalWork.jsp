...
<div id="cc" class="easyui-layout" data-options="fit:true">   
    <div data-options="region:'north',border:false" >
					...
					<tr style = "">
						<!-- 开始时间 --> 
							...
							<td style="width:110px;">
								<input id="STime" class="Wdate" type="text" name="STime" value="${STime}" onClick="WdatePicker({dateFmt:'yyyy-MM'})" style="width:110px;border: 1px solid #95b8e7;border-radius: 5px;"/>
							</td>
							<!-- 结束时间 --> 
							...
							<td style="width:110px;">
					       	...
					       	<td style="width:120px; " class="newMenu">
					    	       	...
					    	       	<input style="width:95px" class="ksnew" id="ksnew" readonly="readonly"/><span></span></div> 
  		...
  		<div data-options="region:'north'" style="height:10%;width: 100%;margin-top:40px">
