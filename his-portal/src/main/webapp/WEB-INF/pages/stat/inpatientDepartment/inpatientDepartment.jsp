...
// 			var Etime = $('#Etime').val();
	...
	function searchFrom1(Stime,Etime) {
		...
		$('#roleMenuList').datagrid({
			url:'<%=basePath%>statistics/inpatientDepartment/inpatientDeptList.action',
			queryParams:{
				sTime:Stime,
				eTime:Etime,
				menuAlias:menuAlias,
	...
	function inHostDept(value,row,index){
		if(value!=null&&value!=0&&value!=''){
			if(row.cyrs!=0){
				return parseFloat(parseFloat(value)/parseFloat(row.cyrs)).toFixed(2)
			}
		}
		return value;
	}
			...
			<div data-options="region:'north',border:false" style="height:38px;padding:5px 5px 0px 5px;">
				...
				<div data-options="region:'center',border:false" >
					<table  style="width: 100%;" id="roleMenuList">
						...
						<thead>
							<tr>
								<th data-options="field:'cfs',align:'center',width:'6%'">处方量</th>
								<th data-options="field:'ryrs',align:'center',width:'6%'">入院人次</th>
								<th data-options="field:'cyrs',align:'center',width:'6%'">出院人次</th>
								<th data-options="field:'avgindate',align:'center',width:'6%',formatter:inHostDept">平均住院日</th>
								<th data-options="field:'operationNum',align:'center',width:'6%'">手术量</th>
								<th data-options="field:'criticallyNum',align:'center',width:'6%'">危重病人数</th>
								<th data-options="field:'deadNum',align:'center',width:'6%'">死亡病人数</th>
							</tr>
						</thead>
					</table>
				</div>
