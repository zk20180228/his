...
//查询按钮
 function searchFrom(){
	 ...
	 $('#tableList').datagrid({    
			url: '<%=basePath%>statistics/criticallyIllPatient/queryCriticallyIllPatient.action',
			queryParams: {
				pageSize:20,
	...
	<div id="cc" class="easyui-layout" data-options="fit:true">   
	 	<form id="saveForm" action="" style="height:80px;width: 100%;padding-top: 8px;padding-top: 8px;padding-right: 10px;padding-left: 10px;">
	 		<table border="0" style="width: 100%;height: 10%">
	    	 	...
	    	 	<tr>
	    	 		<td align="center" colspan="8"  ><font style = "font-size: 32px !important;" class="empWorkTit" size="3">病危患者信息统计</font></td>
	    	 	</tr>
	    	 </table>
	    </form>
	    	...
	    	<table id="tableList" class="easyui-datagrid" style="padding:5px 5px 5px 5px;" data-options="singleSelect:'true',striped:true,fitColumns:true,rownumbers:true,fit:true">
				<thead>
					<tr>
						...
						<th data-options="field:'idcardNo',width:'8%'">就诊卡号</th>
						...
						<th data-options="field:'inDate',width:'8%'">入院时间</th>
