...
function popWin(){
	...
	window.open ("<c:url value='/statistics/wdWin/WDWinToTotCost.action?randomId='/>"+timerStr,'newwindow','height=350,width=700,top=50,left=500,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no');
}
...
// 		remoteSort:false,
		url:'<%=basePath%>bi/totCost/querytTotCostloadDatagrid.action', 
