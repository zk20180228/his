								...
								<tr>
									...
									<tr>
									 <td style='width: 320px;height: 40px;' class='honry-lable' style='width: 5%;' nowrap='nowrap'>费别
									  ...
									  <td style='width: 320px;height: 40px;' class='honry-info' nowrap='nowrap'>
									  &nbsp;<input id="codeNameTdId" class="easyui-combobox" value="" name="invo_code" style='width:200px;'></input>
								     </td>
									</tr>
							</table>
						</form>
		...
		$(function(){
		   ...
		   $('#monthTdId1').combobox({
			...
			$('#codeNameTdId').combobox({
				url:'<%=basePath%>bi/project/casminfeeCombobox.action',
			    ...
			    onSelect:function(node){
			    	 $("#msgTd").html("&nbsp;");
	                    ...
	                    if(sexCodes!=""){
	                    	if(dimensionString==""){
	                        	dimensionString="invo_code,费别";
	                        }else if(dimensionString.indexOf("invo_code")==-1){
	                        	dimensionString=dimensionString+",invo_code,费别";
	                        }
	                    }else{
	                    	if(dimensionString!=""){
	                    		 if(dimensionString.indexOf("invo_code")!=-1){
	                    			 var tmpIndex = dimensionString.indexOf("invo_code");
	                    			 if(tmpIndex!=0){
	                    				 dimensionString= dimensionString.replace(",invo_code,费别","");
	                    			 }else{
	                    				 dimensionString = dimensionString.replace("invo_code,费别,","");
	                    			 }
	                    		 }
		...
		function confirmWd(){
			...
			if(dimensionString.indexOf(",")!=-1){
				...
				for(var i=0;i<diArr.length;i++){
					...
					}if(diArr[i]=="invo_code"){
						if(dimensionValue==""){
							dimensionValue="invo_code,"+sexValue
						}else{
							dimensionValue=dimensionValue+"?invo_code,"+sexValue
						}
					}
				}
			}
