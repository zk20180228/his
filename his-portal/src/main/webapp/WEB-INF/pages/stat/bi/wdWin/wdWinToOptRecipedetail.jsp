								...
								<tr>
									...
									<tr>
									 <td style='width: 320px;height: 40px;' class='honry-lable' style='width: 5%;' nowrap='nowrap'>科室
									  ...
									  <td style='width: 320px;height: 40px;' class='honry-info' nowrap='nowrap'>
									  &nbsp;<input id="deptTdId" class="easyui-combotree" value="" name="reg_dept_code" style='width:200px;'></input>
								     </td>
									</tr>
									<tr>
				 ...
				 onChange:function(){
					 $("#msgTd").html("&nbsp;");
	                    ...
	                    if(deptCodes!=""){ 
	                        ...
	                        }else if(dimensionString.indexOf("reg_dept_code")==-1){
	                        	dimensionString=dimensionString+",reg_dept_code,科室";
	                        }
	                    }else{
	                    	if(dimensionString!=""){
	                    		 if(dimensionString.indexOf("reg_dept_code")!=-1){
	                    			 var tmpIndex = dimensionString.indexOf("reg_dept_code");
	                    			 if(tmpIndex!=0){
	                    				 dimensionString= dimensionString.replace(",reg_dept_code,科室","");
	                    			 }else{
	                    				 var tmpStr = "reg_dept_code,科室";
		...
		function confirmWd(){
			...
			if(dimensionString.indexOf(",")!=-1){
				...
				for(var i=0;i<diArr.length;i++){
					if(diArr[i]=="reg_dept_code"){
						if(dimensionValue==""){
							dimensionValue="reg_dept_code,"+deptValue
						}else{
							dimensionValue=dimensionValue+"?reg_dept_code,"+deptValue
						}
					}
