								...
								<tr>
									...
									<tr>
									 <td style='width: 320px;height: 40px;' class='honry-lable' style='width: 5%;' nowrap='nowrap'>科室
									  ...
									  <td style='width: 320px;height: 40px;' class='honry-info' nowrap='nowrap'>
									  &nbsp;<input id="deptTdId" class="easyui-combotree" value="" name="EXEC_DPCD" style='width:200px;'></input>
								     </td>
									</tr>
							</table>
						</form>
				 ...
				 onChange:function(){
					 $("#msgTd").html("&nbsp;");
	                    ...
	                    if(deptCodes!=""){ 
	                        ...
	                        }else if(dimensionString.indexOf("EXEC_DPCD")==-1){
	                        	dimensionString=dimensionString+",EXEC_DPCD,科室";
	                        }
	                    }else{
	                    	if(dimensionString!=""){
	                    		 if(dimensionString.indexOf("EXEC_DPCD")!=-1){
	                    			 var tmpIndex = dimensionString.indexOf("EXEC_DPCD");
	                    			 if(tmpIndex!=0){
	                    				 dimensionString= dimensionString.replace(",EXEC_DPCD,科室","");
	                    			 }else{
	                    				 var tmpStr = "EXEC_DPCD,科室";
		...
		function confirmWd(){
			...
			if(dimensionString.indexOf(",")!=-1){
				...
				for(var i=0;i<diArr.length;i++){
					if(diArr[i]=="EXEC_DPCD"){
						if(dimensionValue==""){
							dimensionValue="EXEC_DPCD,"+deptValue
						}else{
							dimensionValue=dimensionValue+"?EXEC_DPCD,"+deptValue
						}
					}
				}
			}
