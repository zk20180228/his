...
//	var sex = $('#sex').combobox('getText');
	...
	if(systemType!=""){
		...
		stringfield+='{field:'+'\'codeName\',title:'+'\'项目\',width:'+'\'100px\',align:'+'\'center\'}';
	}
	if(start!=""&&end!=""){
		if(stringfield!=""){
			stringfield = stringfield +",";
	...
	stringfield = stringfield+'{field:'+'\'sumPeople\',title:'+'\'费用\',width:'+'\'100px\',align:'+'\'center\'},{field:'+'\'ordinaryPeople\',title:'+'\'人均费用\',width:'+'\'100px\',align:'+'\'center\'}';
	stringfield='['+stringfield+']';
	stringfield =eval(stringfield);
	columnsArray.push(stringfield); 
	$('#table1').datagrid({
		url:'<%=basePath%>bi/project/toList.action',
		queryParams:{"dimensionVO.dept":deptName,"dimensionVO.start":start,"dimensionVO.end":end,"dimensionVO.codeName":systemType,"dimensionVO.years":times},
		columns:columnsArray,
    ...
    <div data-options="region:'north'" style="height:50px;">
    	<table>
			<tr>
				...
				&nbsp;&nbsp;&nbsp;&nbsp;收费项目：<input id="systemType" class="easyui-combobox" />
