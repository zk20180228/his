...
// 				});
				...
				$(".deptInput").MenuList({
					...
					para:"I,OP,C",	//要传的参数，多个之间用逗号隔开，如果不写默认为查询全部
						...
						$('#list').datagrid({
							...
							onLoadSuccess:function(data){
								...
								for(var i=0;i<aArr.length;i++){
									...
									$('#list').datagrid("autoMergeCells", ['ownDeptName']);
							}
						});
					}
				});
		...
		function changeCost(value,row,index){
		 ...
		 /**
			...
			function searchFrom1(Stime,Etime) {
				...
				var expxrts = $('#doctornew').getMenuIds();
				$('#list').datagrid({
					url:'<%=basePath%>statistics/operationDoctor/operationpatientList.action',
					queryParams:{
						sTime: Stime,
						eTime: Etime,
						menuAlias: menuAlias,
			...
			<div id="tableShow" style="width:100%;margin-top: 7px;height:90%" >
					<table class="easyui-datagrid"  id="list"  data-options="fit:true">
						<thead data-options="frozen:true">
							<tr>
								<th data-options="field:'ownDeptName',align:'center',width:'8%'">科室</th>
								<th data-options="field:'docName',align:'center',width:'5%'">医生</th>
								<th data-options="field:'deptName',align:'center',width:'8%'">手术科室</th>
						    </tr>
						</thead>
						<thead>
							<tr>
								<th data-options="field:'operationNums',align:'center',rowspan:2">手术例数</th>
								<th data-options="field:'ylsr',align:'center',colspan:4">手术分类</th>
								<th data-options="field:'ylsr1',align:'center',colspan:2">是否麻醉</th>
								<th data-options="field:'ylsr2',align:'center',colspan:3">手术规模</th>
								<th data-options="field:'ylsr3',align:'center',colspan:4">手术台类型</th>
							</tr>
							<tr>
								<th data-options="field:'opskindzq',halign:'center',align:'center',width:'4%'">择期</th>
								<th data-options="field:'opskingpt',halign:'center',align:'center',width:'4%'">普通</th>
								<th data-options="field:'opskingjz',halign:'center',align:'center',width:'4%'">急诊</th>
								<th data-options="field:'opskinggr',halign:'center',align:'center',width:'4%'">感染</th>
								<th data-options="field:'anesmz',halign:'center',align:'center',width:'4%'">是</th>
								<th data-options="field:'anesbmz',halign:'center',align:'center',width:'4%'">否</th>
								<th data-options="field:'bigoperation',halign:'center',align:'center',width:'4%'">大</th>
								<th data-options="field:'middleoperation',halign:'center',align:'center',width:'4%'">中</th>
								<th data-options="field:'smalloperation',halign:'center',align:'center',width:'4%'">小</th>
								<th data-options="field:'consolept',halign:'center',align:'center',width:'4%'">普通</th>
								<th data-options="field:'consolejt',halign:'center',align:'center',width:'4%'">加台</th>
								<th data-options="field:'consoledt',halign:'center',align:'center',width:'4%'">点台</th>
								<th data-options="field:'consolejjt',halign:'center',align:'center',width:'4%'">加急台</th>
							</tr>
						</thead>
					</table>
				</div>
