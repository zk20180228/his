...
<html>
	...
	function popWin(){
		...
		window.open ("<%=basePath%>statistics/wdWin/WDWinToExpensesAnaly.action?flag=1",'newwindow','height=350,width=700,top=50,left=500,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no');
	}
	...
	function queryList(dateVo,dateType,dimensionString,dimensionValue,flag){
		...
		$('#table1').datagrid({
			...
			remoteSort:false,
 			url:'<%=basePath%>statistics/expensesAnaly/inpatientExpensesAnalyDatagrid.action', 
