...
$(function(){
	...
	//地域维度
	$('#region').combobox({
		url:'<%=basePath%>bi/passengers/regionCombobox.action',
		valueField: 'cityCode',    
	    textField: 'cityName',  
		multiple:true,
		onSelect:function(data){
...
// 	var deptName = $('#dept').combobox('getText');
	...
	if(sex!=""){
		...
		stringfield+='{field:'+'\'sex\',title:'+'\'性别\',width:'+'\'100px\',align:'+'\'center\'}';
	}
	if(start!=""&&end!=""){
		if(stringfield!=""){
			stringfield = stringfield +",";
	...
	stringfield = stringfield+'{field:'+'\'sumPeople\',title:'+'\'总人次\',width:'+'\'100px\',align:'+'\'center\'},{field:'+'\'ordinaryPeople\',title:'+'\'普诊人次\',width:'+'\'100px\',align:'+'\'center\'},{field:'+'\'emerGencyPeople\',title:'+'\'急诊人次\',width:'+'\'100px\',align:'+'\'center\'}';
	stringfield='['+stringfield+']';
	stringfield =eval(stringfield);
	columnsArray.push(stringfield);
	$('#table1').datagrid({
		url:'<%=basePath%>bi/passengers/toList.action',
		queryParams:{"dimensionVO.sex":sex,"dimensionVO.dept":deptName,"dimensionVO.start":start,"dimensionVO.end":end,"dimensionVO.region":region,"dimensionVO.years":times},
		columns:columnsArray,
        onLoadSuccess: function (data) {//默认选中
			$('#table1').datagrid("autoMergeCells", ['dept','sex','years']);
		},
	});
}
    ...
    <div data-options="region:'north'" style="height:50px;">
    	<table>
			<tr>
				...
				&nbsp;&nbsp;&nbsp;&nbsp;地域：<input id="region" class="easyui-combobox" />
				&nbsp;&nbsp;&nbsp;&nbsp;性别：<input id="sex" class="easyui-combobox" />
