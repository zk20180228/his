...
<script type="text/javascript">
	...
	function queryList(dateArray,dateType,dimensionString,dimensionValue){
		...
		$('#table1').datagrid({
			...
			remoteSort:false,
 			url:'<%=basePath%>statistics/bioperationNum/queryOperationNum.action', 
	...
	*/
	function popWin(){
		...
		window.open ("<c:url value='/statistics/wdWin/WDWinToOpNum.action?randomId='/>"+timerStr,'newwindow','height=350,width=700,top=50,left=500,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no');
	}
