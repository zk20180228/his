		...
		function changeCost(value,row,index){
		 ...
		 /**
			...
			function searchFrom1(Stime,Etime) {
				...
				var expxrts = $('#doctornew').getMenuIds();
				$('#list').datagrid({
					url:'<%=basePath%>/statistics/outpatientDoctor/outpatientList.action',
					queryParams:{
						sTime: Stime,
						eTime: Etime,
						menuAlias: menuAlias,
...
<!-- 			</div> -->
			<div id="tableShow" style="width:100%;margin-top: 7px;height:90%" >
					...
					<thead data-options="frozen:true">
						...
						<thead>
							<tr>
								<th data-options="field:'ghzj',align:'center',rowspan:2">门急诊人次</th>
						...
						<tr>
<!-- 							<th data-options="field:'mzgh',halign:'center',align:'center',width:'5%'">门诊人次</th> -->
<!-- 							<th data-options="field:'jzgh',halign:'center',align:'center',width:'5%'">急诊人次</th> -->
<!-- 							<th data-options="field:'ghzj',halign:'center',align:'center',width:'5%'">合计</th> -->
