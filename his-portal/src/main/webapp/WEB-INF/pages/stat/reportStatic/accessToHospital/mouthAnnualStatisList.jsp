...
<body style="margin: 0px;padding: 0px;">
	<div id="cc" class="easyui-layout" data-options="fit:true">
		<div data-options="region:'center',collapsible:false" id="main" title="出入院情况月度人数统计" style="height:100%;width: 100%;">
			<table id="listopkshz"  class="easyui-datagrid" data-options="rownumbers:true,striped:true,border:true,checkOnSelect:true,
				url:' ${pageContext.request.contextPath}/common/datagrid_data6.json',method:'get',selectOnCheck:false,singleSelect:true,fitColumns:true,fixed:true,fit:true">
				<thead>
					<tr>
					    <th data-options="field:'ck',checkbox:true,rowspan:2" style="width: 1%;"></th>
						<th style="width:8%" data-options="rowspan:2,field:'a'" align="center">月份</th>
