			...
			<div id="divLayout" class="easyui-layout" data-options="fit:true">
			    <div data-options="region:'north',split:false,border:false" style="width:100%;height: 45px;"> 
					<table cellspacing="0" cellpadding="0" border="0" data-options="fit:true">
						<tr>
<!-- 							<td style="padding: 10px 5px;">&nbsp;&nbsp;住院号：</td> -->
							<td style="padding: 10px 5px;">&nbsp;&nbsp;就诊卡号：</td>
							<td>
								<input id="medicalrecordName" style="width:160px;" class="easyui-textbox" data-options="prompt:'请输入就诊卡号回车查询'"/>																
							</td>
