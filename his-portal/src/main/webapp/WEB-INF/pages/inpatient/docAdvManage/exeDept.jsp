		...
		<div>
		   <div style="padding: 5px 5px 0px 5px;">
			...
			<div style="padding: 5px 5px 5px 5px;">
				<table id="deptiInfoViewListId" class="easyui-datagrid" style="width:100%;height:450px" data-options="method:'post',rownumbers:true,idField: 'id',striped:true,border:true,checkOnSelect:true,selectOnCheck:false,singleSelect:true,fitColumns:false">
					<thead>
						<tr>
			...
			$(function(){
				...
				$('#deptiInfoViewListId').datagrid({	
					...
					onDblClickRow:function(rowIndex, rowData){						
						...
						if($('#adProjectTdId') .combobox('getValue')=='402880b751f104d10151f19402800008'){
