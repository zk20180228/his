		...
		<div data-options="region:'center',border:false" style="width: 100%;height: 100%;padding:5px" align="center">
			...
			<table class="honry-table"  cellpadding="1" cellspacing="1"	border="1px solid black" style="width:100%;padding:5px">
						...
						<tr>
							...
							<td>
								<input id="sexCode" name="sexCode1" class="easyui-textbox"  value="${inpatientApplyNow.sexName}" readonly="readonly">
							...
							<td>
								<input id="keshi"  readonly="readonly"
					...
					<tr>
						...
						<td>
							<input class="easyui-numberbox" id='yuding' name="quantity" value="${inpatientApplyNow.quantity}" style="width: 50px;" data-options="required:true,missingMessage:'只能输入数字'">　　
					...
					<tr>
						...
						<td>
							<input id="CodeSex" name="hematin" class="easyui-numberbox" value="${inpatientApplyNow.hematin}" data-options="required:true">g/L
						</td>
						</tr>
						<tr>
						<td class="honry-lable">
						...
						<td>
							<input id="CodeSex" name="hct" class="easyui-numberbox"  value="${inpatientApplyNow.hct}" data-options="required:true">
						</td>
						<td class="honry-lable">
							血小板：
						</td>
						<td>
							<input id="CodeSex" name="platelet" class="easyui-numberbox" value="${inpatientApplyNow.platelet}" data-options="required:true">
							x10 <sup>9</sup>/L
						</td>
						</tr>
						<tr>
						...
						<td>
							<input id="CodeSex" name="alt" class="easyui-numberbox" value="${inpatientApplyNow.alt}" data-options="required:true">
							U/L
						</td>
						<td class="honry-lable">
							HbsAg：
