...
<html>
				...
				<form id="editForm">
					...
					<div id="tt" class="easyui-tabs" data-options="" style="">
						<div title="第一页" style="padding:10px">
							<jsp:include page="frirstEditTab.jsp"></jsp:include>
						</div>
	   ...
	   //从xml文件中解析，读到下拉框
		 ...
		 */
		  	...
		  	$('#editForm').form('submit',{
		  		url:"<c:url value='inpatient/info/editInpatientInfo.action'/>",
		  		 onSubmit:function(){ 
	 ...
	 */
	function openBed(){
		AddBeddilog("病床", "<c:url value='/baseinfo/hospitalbed/listHospitalbed.action'/>");
	}
	...
	function getPatient(value) {
			$.ajax({
						url: "<c:url value='inpatient/getPatientByIdcard.action'/>?id="+value,
						type:'get',
						success: function(data) {
