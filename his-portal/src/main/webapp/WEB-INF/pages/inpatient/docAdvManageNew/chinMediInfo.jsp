	...
	<body>
			...
			<table style="width: 100%; border: 1px solid #95b8e7; padding: 5px 5px 5px 5px;">
				<tr>
					...
					<td style="width:170px">
						<input id="adChinMediInfoModelStaTdId" class="Wdate" type="text" data-options="showSeconds:true" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" style="width:150px;border: 1px solid #95b8e7;border-radius: 5px;"/>
					</td>
				...
				<tr>
					...
					<td>
						<input id="adChinMediInfoModelEndTdId" class="Wdate" type="text" data-options="showSeconds:true" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" style="width:150px;border: 1px solid #95b8e7;border-radius: 5px;"/>
					</td>
					<td align="right">用法：</td>
					<td><input id="adChinMediInfoModelUseTdId" class="easyui-combobox" data-options="" style="width:120px;"/></td>
					<td></td>
				    <td></td>
				</tr>
			</table>
		...
		<script type="text/javascript">
			...
			function adChinMediInfoModelSta(){
				...
				if(rows!=null&&rows.length>0){
					if(rows.length==1){
						...
						var staDate = $('#adChinMediInfoModelStaTdId').val();
						var endDate = $('#adChinMediInfoModelEndTdId').val();
						...
						for(var i=0;i<rows.length;i++){
							$('#adStackInfoSaveModelDgId').datagrid('appendRow',{
								...
								usageCode:$('#adChinMediInfoModelUseTdId').combobox('getValue'),//用法名称,//用法Id
			...
			function adChinMediInfoModelYes(){
				...
				var useVal = $('#adChinMediInfoModelUseTdId').combobox('getText');
				if(useVal==null||useVal==''){
									...
									if(rows[i].id!=null&&rows[i].id!=''){
										...
										if(tab.title=='长期医嘱'){	
											var lastIndex = $('#infolistA').datagrid('appendRow',{
												...
												usageCode:$('#adChinMediInfoModelUseTdId').combobox('getValue'),//用法名称,//用法Id
												useName:$('#adChinMediInfoModelUseTdId').combobox('getText'),//用法名称
