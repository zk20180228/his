...
<html>
	<body>
		<div style="padding:5px 5px 5px 5px;">
			...
			<table class="easyui-datagrid"  style="padding:5px 5px 5px 5px;" id="adStackInfoSaveModelDgId"data-options="rownumbers:true,striped:true,border:true,checkOnSelect:true,selectOnCheck:false,singleSelect:true,fit:true"> 
				 <thead>   
			        <tr>   
			            ...
			            <th data-options="field:'frequencyCodeView',width:100">频次</th>   
