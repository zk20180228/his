...
<html>
	...
	<body style="margin:0px;padding:0px">
		<div id="unDrugEl" class="easyui-layout" data-options="fit:true">   
			...
			<div data-options="region:'center'" class="unDrug">
				<div style="width:100%;height:100%;">
					<table id="listnon">
					<thead>
						<tr>
							<th data-options="field:'name'" style="width:15%">项目名称</th>
							<th data-options="field:'undrugPinyin'" style="width:10%">拼音码</th>
							<th data-options="field:'undrugWb'" style="width:10%">五笔码</th>
							<th data-options="field:'undrugInputcode'" style="width:10%">自定义码</th>
							<th data-options="field:'defaultprice'" style="width:10%">默认价</th>
							...
							<th data-options="field:'undrugIsownexpense',formatter:replaceTrueOrFalse" style="width:8%">自费</th>
							<th data-options="field:'undrugIsc',formatter:replaceTrueOrFalse" style="width:8%">组套</th>
							<th data-options="field:'undrugDiseaseclassification',formatter:diseasetypeFamater" style="width:8%">疾病分类</th>
							<th data-options="field:'undrugRemark'" style="width:10%">备注</th>
						</tr>
					</thead>
				</table>
				</div>
		...
		$('#listnon').datagrid({
			...
			onDblClickRow : function(rowIndex, rowData) {//双击查看
				...
				if(row){
					AdddilogDrugs("查看非药品","<%=basePath%>drug/undrug/viewUndrug.action?id="+row.id);
				}
