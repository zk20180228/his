			    ...
			    <div data-options="region:'center',border:false" style="padding-top: 20px" align="center">
			    	<form method="post" id="editFrom">
			    		<table>
				    		<tr>
				    			<td>
				    				变更原因：<input id="querydrug" name="businessChangeRecord.changeCause" class="easyui-textbox" value="${changeCause }">
				    				<input type="hidden" name="businessChangeRecord.id" value="${id }">
				    			</td>
				    		</tr>
			...
			<script type="text/javascript">
				function save(){
					$('#editFrom').form('submit', {    
						url:'<%=basePath%>baseinfo/changeRecord/updateBusinessChangeRecord.action',
