...
<body>
	<div class="easyui-layout" style="width: 100%; height: 100%;">
		<div id="p" data-options="region:'west'" title="患者信息"
		...
		<div data-options="region:'center'" >
			<div id="divLayout" class="easyui-layout" fit=true>
				<div
					data-options="region:'center',split:false,title:'患者信息列表'"
					style="padding: 5px;">
					<form id="editForm">
							<div class="easyui-panel" style="padding: 5px 5px 0px 5px"
								...
								<table id="list" cellspacing="0" cellpadding="0" border="0">
									<tr>
										...
										<td>
											&nbsp;&nbsp;
											<shiro:hasPermission name="SSJLWH:function:query">
						...
						<div style="padding: 5px 5px 0px 5px">
							<tr>
								<th>
									<span style="padding-left: 45%;font-size:18">手术申请单</span>
								</th>
							</tr>
						</div>
						<div style="padding: 5px 5px 0px 5px">
							<table class="honry-table" cellpadding="0" cellspacing="0"
								...
								<tr>
									...
									<td>
										<input id="inDept" name="inDept.id" data-options="required:true"  >
										<a href="javascript:delSelectedData('inDept');"  class="easyui-linkbutton" 
							...
							<table class="honry-table" cellpadding="0" cellspacing="0"
								...
								<tr>
									...
									<td>
										...
										<a href="javascript:delSelectedData('mzysbm');"  class="easyui-linkbutton" data-options="iconCls:'icon-opera_clear',plain:true"></a>
									</td>
									...
									<td>
										...
										<a href="javascript:delSelectedData('zhushou1');"  class="easyui-linkbutton" data-options="iconCls:'icon-opera_clear',plain:true"></a>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										...
										<a href="javascript:delSelectedData('zdysbm');"  class="easyui-linkbutton" data-options="iconCls:'icon-opera_clear',plain:true"></a>
									</td>
									<td class="honry-lable">
										助手2：
									</td>
									<td>
										<input id="zhushou2" name="opAssist2" >
										<a href="javascript:delSelectedData('zhushou2');"  class="easyui-linkbutton" data-options="iconCls:'icon-opera_clear',plain:true"></a>
									</td>
								</tr>
								<tr>
									<td class="honry-lable">
									...
									<td>
										...
										<a href="javascript:delSelectedData('ssysbm');"  class="easyui-linkbutton" data-options="iconCls:'icon-opera_clear',plain:true"></a>
									</td>
									...
									<td>
										<input id="zhushou3" name="opAssist3" >
										<a href="javascript:delSelectedData('zhushou3');"  class="easyui-linkbutton" data-options="iconCls:'icon-opera_clear',plain:true"></a>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										...
										<a href="javascript:delSelectedData('lszs1');"  class="easyui-linkbutton" data-options="iconCls:'icon-opera_clear',plain:true"></a>
									</td>
								...
								<tr>
									...
									<td>
										...
										<a href="javascript:delSelectedData('keshi');"  class="easyui-linkbutton" data-options="iconCls:'icon-opera_clear',plain:true"></a>
									</td>
									<td class="honry-lable">
										临时助手2：
									</td>
									<td>
										<input id="lszs2" name="opTempassist2" >
										<a href="javascript:delSelectedData('lszs2');"  class="easyui-linkbutton" data-options="iconCls:'icon-opera_clear',plain:true"></a>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<input id="nssmc1Hidden" type="hidden">
										<input id="nssmc1" name="opName1"  data-options="required:true">
										<a href="javascript:delSelectedData('nssmc1,nssmc2,nssmc3');"  class="easyui-linkbutton" data-options="iconCls:'icon-opera_clear',plain:true"></a>
									</td>
								...
								<tr>
									...
									<td>
										<input id="nssmc2Hidden" type="hidden">
										<input id="nssmc2" name="opName2">
										<a href="javascript:delSelectedData('nssmc2,nssmc3');"  class="easyui-linkbutton" data-options="iconCls:'icon-opera_clear',plain:true"></a>
									</td>
								</tr>
								<tr>
									<td class="honry-lable">
									...
									<td>
										<input  id="nssmc3Hidden" type="hidden">
										<input id="nssmc3" name="opName3" >
										<a href="javascript:delSelectedData('nssmc3');"  class="easyui-linkbutton" data-options="iconCls:'icon-opera_clear',plain:true"></a>
									</td>
								</tr>
								<tr>
									<td class="honry-lable">
								...
								<tr>
									...
									<td colspan="5">
										...
										<a href="javascript:delSelectedData('execDept');"  class="easyui-linkbutton" 
										data-options="iconCls:'icon-opera_clear',plain:true"></a>
									</td>
								</tr>
						...
						<div  style="text-align: center;padding: 5px 5px 0px 5px"
								border="0" style="width: 100%">
									<shiro:hasPermission name="SSJLWH:function:add">
...
/* 	//手术诊断3
					...
					if (id2 == null || id2 == "") {
						if (id != null) {
							$('#nssmc2').combobox('reload',
									'baseinfo/undrug/undrugCombobox.action?ids=' + id);
						}
					}
					if (id3 == null || id3 == "") {
						if (id != null) {
	...
	$('#CodeSex').combobox({
			    url:'comboBox.action?str='+"CodeSex",    
			    valueField:'id',    
			    textField:'name',
			    multiple:false
			});
	...
	bindEnterEvent('execDept',popWinToDeptZX,'easyui');//绑定执行回车事件
	bindEnterEvent('inDept',popWinToDept,'easyui');//绑定住院科室回车事件
	bindEnterEvent('zhushou1',popWinToEmployeeOne,'easyui');//绑定zhushou回车事件
	bindEnterEvent('zhushou2',popWinToEmployeeTwo,'easyui');//绑定zhushou回车事件
	bindEnterEvent('zhushou3',popWinToEmployeeThree,'easyui');//绑定zhushou回车事件
	bindEnterEvent('lszs1',popWinToEmployeeLSOne,'easyui');//绑定zhushou回车事件
	bindEnterEvent('lszs2',popWinToEmployeeLSTwo,'easyui');//绑定zhushou回车事件
	bindEnterEvent('mzysbm',popWinToEmployeeMZYS,'easyui');//绑定zhushou回车事件
	bindEnterEvent('sqysbm',popWinToEmployeeSQYS,'easyui');//绑定zhushou回车事件
	bindEnterEvent('zdysbm',popWinToEmployeeZDYS,'easyui');//绑定zhushou回车事件
	bindEnterEvent('ssysbm',popWinToEmployeeSSYS,'easyui');//绑定zhushou回车事件
	bindEnterEvent('keshi',popWinToDeptSSYS,'easyui');//绑定手术医生科室回车事件
	bindEnterEvent('nssmc1',popWinToShouShuNSSMC1,'easyui');//绑定拟手术名称1回车事件
	bindEnterEvent('nssmc2',popWinToShouShuNSSMC2,'easyui');//绑定拟手术名称2回车事件
	bindEnterEvent('nssmc3',popWinToShouShuNSSMC3,'easyui');//绑定拟手术名称3回车事件
  ...
  /**
		 ...
		 */
	     function searchFrom(){
	     	...
	     	if(clinicCode.length!=6){
	     		$.messager.alert('提示信息','请输入住院流水号或者病历号的后六位！');
	     		setTimeout(function(){
		...
		$('#editForm').form('submit', {
			...
			success : function(data) {
				...
				$.messager.alert('提示信息','保存成功！');
		             //实现刷新栏目中的数据
                    window.location.href='listOperationapply.action';
		        },
				error : function(data) {
					$.messager.progress('close');
	...
	$('#tDt').tree({
		...
		formatter : function(node) {//统计节点总数
			...
			if (id != null && id != "") {
			   if(type=="2"){
			      $.ajax({
								url: 'queryOperationApplyById.action?oid='+id,
								type:'post',
								success: function(data) {
				...
				$.ajax({
					url: 'queryinpatientinfo.action?id='+id,
					type:'post',
					success: function(data) {
	...
	*/
	...
	function popWinToDept(){
		var tempWinPath = "<%=basePath%>popWin/popWinDepartment/toDepartmentPopWin.action?textId=inDept";
	...
	*/
	...
	function popWinToDeptZX(){
		var tempWinPath = "<%=basePath%>popWin/popWinDepartment/toDepartmentPopWin.action?textId=execDept";
		window.open (tempWinPath,'newwindow',' left=400,top=200,width='+ (screen.availWidth -700) +',height='+ (screen.availHeight-370) 
	    +',scrollbars,resizable=yes,toolbar=yes')
	}
	 /**
	   ...
	   * @version 1.0
	   */
	   function popWinToEmployeeOne(){
		    var tempWinPath = "<%=basePath%>popWin/popWinEmployee/toEmployeePopWin.action?textId=zhushou1&employeeType=1";
	 ...
	 /**
	   ...
	   * @version 1.0
	   */
	   function popWinToEmployeeTwo(){
		    var tempWinPath = "<%=basePath%>popWin/popWinEmployee/toEmployeePopWin.action?textId=zhushou2&employeeType=1";
			window.open (tempWinPath,'newwindow',' left=400,top=200,width='+ (screen.availWidth -700) +',height='+ (screen.availHeight-370)+',scrollbars,resizable=yes,toolbar=yes')
	   ...
	   * @version 1.0
	   */
	   function popWinToEmployeeThree(){
		    var tempWinPath = "<%=basePath%>popWin/popWinEmployee/toEmployeePopWin.action?textId=zhushou3&employeeType=1";
			window.open (tempWinPath,'newwindow',' left=400,top=200,width='+ (screen.availWidth -700) +',height='+ (screen.availHeight-370)+',scrollbars,resizable=yes,toolbar=yes')
	 ...
	 /**
	   ...
	   * @version 1.0
	   */
	   function popWinToEmployeeLSOne(){
		    var tempWinPath = "<%=basePath%>popWin/popWinEmployee/toEmployeePopWin.action?textId=lszs1&employeeType=1";
			window.open (tempWinPath,'newwindow',' left=400,top=200,width='+ (screen.availWidth -700) +',height='+ (screen.availHeight-370)+',scrollbars,resizable=yes,toolbar=yes')
	 ...
	 /**
	   ...
	   * @version 1.0
	   */
	   function popWinToEmployeeLSTwo(){
		    var tempWinPath = "<%=basePath%>popWin/popWinEmployee/toEmployeePopWin.action?textId=lszs2&employeeType=1";
			window.open (tempWinPath,'newwindow',' left=400,top=200,width='+ (screen.availWidth -700) +',height='+ (screen.availHeight-370)+',scrollbars,resizable=yes,toolbar=yes')
	   ...
	   /**
		   ...
		   * @version 1.0
		   */
		   function popWinToEmployeeMZYS(){
			    var tempWinPath = "<%=basePath%>popWin/popWinEmployee/toEmployeePopWin.action?textId=mzysbm&employeeType=1";
				window.open (tempWinPath,'newwindow',' left=400,top=200,width='+ (screen.availWidth -700) +',height='+ (screen.availHeight-370)+',scrollbars,resizable=yes,toolbar=yes')
	   ...
	   /**
		   ...
		   * @version 1.0
		   */
		   function popWinToEmployeeZDYS(){
			    var tempWinPath = "<%=basePath%>popWin/popWinEmployee/toEmployeePopWin.action?textId=zdysbm&employeeType=1";
				window.open (tempWinPath,'newwindow',' left=400,top=200,width='+ (screen.availWidth -700) +',height='+ (screen.availHeight-370)+',scrollbars,resizable=yes,toolbar=yes')
	   ...
	   /**
		   ...
		   * @version 1.0
		   */
		   function popWinToEmployeeSQYS(){
			    var tempWinPath = "<%=basePath%>popWin/popWinEmployee/toEmployeePopWin.action?textId=sqysbm&employeeType=1";
				window.open (tempWinPath,'newwindow',' left=400,top=200,width='+ (screen.availWidth -700) +',height='+ (screen.availHeight-370)+',scrollbars,resizable=yes,toolbar=yes')
	   ...
	   /**
		   ...
		   * @version 1.0
		   */
		   function popWinToEmployeeSSYS(){
			    var tempWinPath = "<%=basePath%>popWin/popWinEmployee/toEmployeePopWin.action?textId=ssysbm&employeeType=1";
				window.open (tempWinPath,'newwindow',' left=400,top=200,width='+ (screen.availWidth -700) +',height='+ (screen.availHeight-370)+',scrollbars,resizable=yes,toolbar=yes')
		...
		*/
		...
		function popWinToDeptSSYS(){
			var tempWinPath = "<%=basePath%>popWin/popWinDepartment/toDepartmentPopWin.action?textId=keshi";
			window.open (tempWinPath,'newwindow',' left=400,top=200,width='+ (screen.availWidth -700) +',height='+ (screen.availHeight-370) 
		    +',scrollbars,resizable=yes,toolbar=yes')
		}
		...
		function popWinToShouShuNSSMC1(){
			 $("#nssmc2").combobox('setValue','');
			 $("#nssmc3").combobox('setValue','');
			 popWinDrugCallBackFn = function(node){
			    	$("#nssmc1Hidden").val(node.id);
				    $('#nssmc1').textbox('setValue',node.name);
			};
			var tempWinPath = "<%=basePath%>/popWin/popWinDrugUndrug/toDrugUndrugPopWin.action?textId=nssmc1";
			var aaa=window.open (tempWinPath,'newwindow',' left=400,top=200,width='+ (screen.availWidth - 800) +',height='+(screen.availHeight-400) +',scrollbars,resizable=yes,toolbar=no')
		...
		function popWinToShouShuNSSMC2(){
			 var id=$("#nssmc1Hidden").val();
			 $("#nssmc3").combobox('setValue','');
			 popWinDrugCallBackFn = function(node){
		    	 $("#nssmc2Hidden").val(node.id);
				 $('#nssmc2').textbox('setValue',node.name);
			};
			var tempWinPath = "<%=basePath%>/popWin/popWinDrugUndrug/toDrugUndrugPopWin.action?textId=nssmc2&id="+id;
			var aaa=window.open (tempWinPath,'newwindow',' left=400,top=200,width='+ (screen.availWidth - 800) +',height='+(screen.availHeight-400) +',scrollbars,resizable=yes,toolbar=no')
		...
		function popWinToShouShuNSSMC3(){
			 var id=$("#nssmc1Hidden").val();
			 var ids=$("#nssmc2Hidden").val();
			 popWinDrugCallBackFn = function(node){
		    	 $("#nssmc3Hidden").val(node.id);
				 $('#nssmc3').textbox('setValue',node.name);
			};
			var tempWinPath = "<%=basePath%>/popWin/popWinDrugUndrug/toDrugUndrugPopWin.action?textId=nssmc3&id="+id+","+ids;
			var aaa=window.open (tempWinPath,'newwindow',' left=400,top=200,width='+ (screen.availWidth - 800) +',height='+(screen.availHeight-400) +',scrollbars,resizable=yes,toolbar=no')
