...
//		console.log("2449-绑定month-view中的双击事件");
...
//		console.log("3379-时间段内双击新增事件");
		cells.dblclick(slotClick)
...
//		console.log("3685-slotSelectionMousedown");
