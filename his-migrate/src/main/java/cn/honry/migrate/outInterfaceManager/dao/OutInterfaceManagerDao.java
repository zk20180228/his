package cn.honry.migrate.outInterfaceManager.dao;
...
public interface OutInterfaceManagerDao extends EntityDao<ExterInter> {
	 ...
	 *
	 */
	void delInter(String s) throws Exception;
