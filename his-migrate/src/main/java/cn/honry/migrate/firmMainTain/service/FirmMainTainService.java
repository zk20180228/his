package cn.honry.migrate.firmMainTain.service;
...
public interface FirmMainTainService{
	/**  
	 * 厂商维护列表查询
	 * @Author: wangshujuan
	 ...
	 * @version: V1.0
	 */
	void saveFirmMainTain(FirmMainTain firmMainTain);
	/**  
	 * 厂商维护  删除
	 * @Author: wangshujuan
	 * @CreateDate: 2017年9月19日 下午4:09:43 
	 ...
	 * @throws Exception 
	 */
	void delFirmMainTain(String code) throws Exception;
	/**  
	 * 厂商维护  得到要修改的数据
	 * @Author: wangshujuan
	 * @CreateDate: 2017年9月19日 下午4:09:43 
	 ...
	 * @param code 
	 */
	FirmMainTain getOnedata(String code);
