package cn.honry.oa.patInformation.dao;
...
public interface PatInformationDao extends EntityDao<Information> {
	/**  
	 * 
	 * <p>根据id获取栏目信息 </p>
	 * @Author: mrb
	 ...
	 * <p>获取所有患者APP注册用户 </p>
	 * @Author: mrb
	 * @CreateDate: 2018年1月3日 下午6:48:29 
	 * @Modifier: mrb
	 * @ModifyDate: 2018年1月3日 下午6:48:29 
	 * @ModifyRmk:  
	 * @version: V1.0
	 * @return
	 * List<String>
	 */
	List<String> getPatientAppUser();
}
