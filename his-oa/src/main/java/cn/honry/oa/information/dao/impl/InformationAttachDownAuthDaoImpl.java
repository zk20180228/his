package cn.honry.oa.information.dao.impl;
...
@Repository("informationAttachDownAuthDao")
@SuppressWarnings({"all"})
public class InformationAttachDownAuthDaoImpl extends HibernateEntityDao<InformationAttachDownAuth>
		implements InformationAttachDownAuthDao {
