package cn.honry.oa.patmenumanager.dao.impl;
...
@Repository("patMenuManagerDao")
public class PatMenuManagerDaoImpl extends HibernateEntityDao<OaMenu> implements PatMenuManagerDao {
	...
	public List<MenuVo> findAllChild(String code) throws Exception{
		...
		sb.append("select t.menu_name name, t.menu_code code, t.menu_path path from t_oa_menu t where t.del_flag = '0' and t.type='1' ");
	...
	public List<MenuVo> queryMenuByParentcode(String code) {
		...
		sb.append(" from t_oa_menu t where t.del_flag = '0' and t.type='1' ");
	...
	public List<OaMenu> queryAllChildren(String path) {
		...
		sb.append(" from t_oa_menu t where t.del_flag = '0' and t.stop_flag = '0' and t.type='1' ");
	...
	public List<MenuVo> findAllChilds(String id) {
		...
		sb.append(" and t.Menu_Parentcode = ").append("'"+id+"'");
		sb.append(" order by t.menu_order");
	...
	public List<MenuVo> findAllChildWithOutStop(String code) {
		...
		StringBuilder sb = new StringBuilder();
		sb.append("select t.menu_name name, t.menu_code code, t.menu_path path from t_oa_menu t where t.del_flag = '0' and t.stop_flag = '0' and t.type='1' ");
		sb.append(" and t.menu_parentpath = ").append("'"+code+"'");
		sb.append(" order by t.menu_order");
	...
	@Override
	public void delChildMenu(String patarentCode) {
		StringBuffer sb = new StringBuffer();
		sb.append(" Update t_Oa_Menu Set Del_Flag = 1 Where Del_Flag = '0' And Type = '1' And Menu_Parentcode = '"+patarentCode+"' ");
	...
	public void delMenu(String code) {
		StringBuffer sb = new StringBuffer();
		sb.append(" Update t_Oa_Menu Set Del_Flag = 1 Where Del_Flag = '0' And Type = '1' And Menu_Code = '"+code+"' ");
		Session session = this.getSessionFactory().getCurrentSession();
		SQLQuery query = session.createSQLQuery(sb.toString());
		query.executeUpdate();
	}
