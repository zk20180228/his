package cn.honry.oa.patmenumanager.dao;
...
public interface PatMenuManagerDao  extends EntityDao<OaMenu> {
	...
	void delChildMenu(String patarentCode);
	void delMenu(String code );
}
