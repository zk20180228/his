...
public class TecSchedule extends Entity implements java.io.Serializable {

	// Fields

	private String scheduleModelid;//医技排班模板编号
	...
	public String getScheduleModelid() {
		return this.scheduleModelid;
	}

	public void setScheduleModelid(String scheduleModelid) {
		this.scheduleModelid = scheduleModelid;
	}
