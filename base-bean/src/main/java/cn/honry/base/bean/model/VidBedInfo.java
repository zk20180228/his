...
public class VidBedInfo {
	...
	public void setBedInDate(Date bedInDate) {
		this.bedInDate = bedInDate;
	}
	public Date getBedOutDate() {
		return bedOutDate;
	}
	public void setBedOutDate(Date bedOutDate) {
		this.bedOutDate = bedOutDate;
	}
