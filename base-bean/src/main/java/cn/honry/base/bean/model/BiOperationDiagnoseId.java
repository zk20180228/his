...
/**
 * BiOperationDiagnoseId entity. @author MyEclipse Persistence Tools
 */

public class BiOperationDiagnoseId implements java.io.Serializable {
	...
	/** default constructor */
	public BiOperationDiagnoseId() {
	}

	/** full constructor */
	public BiOperationDiagnoseId(String operationId, Long happenNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof BiOperationDiagnoseId))
			return false;
		BiOperationDiagnoseId castOther = (BiOperationDiagnoseId) other;
