 ...
 * hedong 预交金表
 */
public class InpatientInPrepayNow extends Entity implements
	...
	private String payWay;// 支付方式CA现金CH支票CD信用卡DB借记卡AJ转押金PO汇票PS保险帐户YS院内账户 pay_way
							// VARCHAR2(2),
	...
	private Integer balanceState;// 结算标志 0:未结算；1:已结算 2:已结转 balance_state
									// NUMBER(1),
	private Integer prepayState;// 预交金状态0:收取；1:作废;2:补打,3结算召回作废 prepay_state
								// NUMBER(1),
	...
	private Integer changeBalanceNo;// 转押金时结算序号 change_balance_no NUMBER(2),
									// 已与sun商量改为字符串类型
