...
public class RegistrationNow extends Entity{
	...
	/**0-普通门诊，1-急诊**/
	private Integer emergency_flag;
	...
	public Integer getEmergency_flag() {
		return emergency_flag;
	}
	public void setEmergency_flag(Integer emergency_flag) {
