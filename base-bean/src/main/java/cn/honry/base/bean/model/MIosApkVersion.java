...
public class MIosApkVersion extends Entity{
	...
	private Integer sendRadio;//是否发送广播 1:否 （不需要发送）2：是（需要发送）
	...
	public Integer getSendRadio() {
		return sendRadio;
	}

	public void setSendRadio(Integer sendRadio) {
		this.sendRadio = sendRadio;
	}
