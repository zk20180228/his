...
public class DrugOutstore extends Entity implements java.io.Serializable {
	...
	/**报表打印**/
	private List<DrugOutstore> drugOutstoreList;
	
	public List<DrugOutstore> getDrugOutstoreList() {
		return drugOutstoreList;
	}
	public void setDrugOutstoreList(List<DrugOutstore> drugOutstoreList) {
		this.drugOutstoreList = drugOutstoreList;
	}
	...
	public Double getPlaceCode() {
		return placeCode;
	}
	public void setPlaceCode(Double placeCode) {
	...
	public String getNotPrintDate() {
		return notPrintDate;
	}
	public void setNotPrintDate(String notPrintDate) {
		this.notPrintDate = notPrintDate;
	}
	@Override
	public String toString() {
		return "DrugOutstore [drugDeptCode=" + drugDeptCode + ", outBillCode="
				+ outBillCode + ", serialCode=" + serialCode + ", groupCode="
				+ groupCode + ", outListCode=" + outListCode + ", outType="
				+ outType + ", inBillCode=" + inBillCode + ", outSerialCode="
				+ outSerialCode + ", inListCode=" + inListCode + ", drugCode="
				+ drugCode + ", tradeName=" + tradeName + ", drugType="
				+ drugType + ", drugQuality=" + drugQuality + ", specs="
				+ specs + ", packUnit=" + packUnit + ", packQty=" + packQty
				+ ", minUnit=" + minUnit + ", showFlag=" + showFlag
				+ ", showUnit=" + showUnit + ", batchNo=" + batchNo
				+ ", validDate=" + validDate + ", producerCode=" + producerCode
				+ ", companyCode=" + companyCode + ", retailPrice="
				+ retailPrice + ", wholesalePrice=" + wholesalePrice
				+ ", purchasePrice=" + purchasePrice + ", outNum=" + outNum
				+ ", retailCost=" + retailCost + ", wholesaleCost="
				+ wholesaleCost + ", purchaseCost=" + purchaseCost
				+ ", storeNum=" + storeNum + ", storeCost=" + storeCost
				+ ", specialFlag=" + specialFlag + ", outState=" + outState
				+ ", applyNum=" + applyNum + ", applyOpercode=" + applyOpercode
				+ ", applyDate=" + applyDate + ", examNum=" + examNum
				+ ", examOpercode=" + examOpercode + ", examDate=" + examDate
				+ ", approveOpercode=" + approveOpercode + ", approveDate="
				+ approveDate + ", placeCode=" + placeCode + ", returnNum="
				+ returnNum + ", drugedBill=" + drugedBill + ", medId=" + medId
				+ ", drugStorageCode=" + drugStorageCode + ", recipeNo="
				+ recipeNo + ", sequenceNo=" + sequenceNo + ", signPerson="
				+ signPerson + ", getPerson=" + getPerson + ", strikeFlag="
				+ strikeFlag + ", arkFlag=" + arkFlag + ", arkBillCode="
				+ arkBillCode + ", outDate=" + outDate + ", remark=" + remark
				+ ", drugName=" + drugName + ", drugNamepinyin="
				+ drugNamepinyin + ", drugNamewb=" + drugNamewb
				+ ", drugNameinputcode=" + drugNameinputcode
				+ ", drugCommonname=" + drugCommonname + ", drugCnamepinyin="
				+ drugCnamepinyin + ", drugCnamewb=" + drugCnamewb
				+ ", drugCnameinputcode=" + drugCnameinputcode + ", drugSpec="
				+ drugSpec + ", drugDosageform=" + drugDosageform
				+ ", drugRetailprice=" + drugRetailprice + ", drugMinimumunit="
				+ drugMinimumunit + ", drugPackagingnum=" + drugPackagingnum
				+ ", drugPackagingunit=" + drugPackagingunit + ", storeSum="
				+ storeSum + ", outlCost=" + outlCost + ", flagId=" + flagId
				+ ", beforeOutSum=" + beforeOutSum + ", returnOutCost="
				+ returnOutCost + ", applyoutId=" + applyoutId
				+ ", oldRetailPrice=" + oldRetailPrice + ", manufacturerName="
				+ manufacturerName + ", num=" + num + ", differentId="
				+ differentId + ", drugWholesaleprice=" + drugWholesaleprice
				+ ", drugPurchaseprice=" + drugPurchaseprice
				+ ", drugStorageName=" + drugStorageName + ", drugDeptName="
				+ drugDeptName + ", examOpername=" + examOpername
				+ ", approveOpername=" + approveOpername + ", signPersonName="
				+ signPersonName + ", getPersonName=" + getPersonName
				+ ", drugedName=" + drugedName + ", producerName="
				+ producerName + ", companyName=" + companyName + ", opType="
				+ opType + ", drugOutstoreList=" + drugOutstoreList + "]";
	}
