...
public class VidCardInfo {
	...
	public String getInfoIdcardNo() {
		return infoIdcardNo;
	}
	public void setInfoIdcardNo(String infoIdcardNo) {
		this.infoIdcardNo = infoIdcardNo;
	}
