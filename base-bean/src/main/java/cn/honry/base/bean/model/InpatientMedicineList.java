 ...
 * @version 1.0
 */
public class InpatientMedicineList extends Entity implements
	...
	/** 报表所用字段 **/
	private List<InpatientMedicineList> inpatientMedicineList;
	// 新加字段
	/** 在院科室名称 **/
	...
	public List<InpatientMedicineList> getInpatientMedicineList() {
		return inpatientMedicineList;
	}

	public void setInpatientMedicineList(
			List<InpatientMedicineList> inpatientMedicineList) {
		this.inpatientMedicineList = inpatientMedicineList;
	}
