...
/**
 * TOutpatientRecipedetailNow entity. @author MyEclipse Persistence Tools
 */

public class OutpatientRecipedetailNow extends Entity{
	...
	public void add(OutpatientRecipedetailNow node) {
	...
	public String toString() {
		return "OutpatientRecipedetailNow [seeNo=" + seeNo + ", _parentId="
				+ _parentId + ", clinicCode=" + clinicCode + ", patientNo="
				+ patientNo + ", regDate=" + regDate + ", regDept=" + regDept
				+ ", itemCode=" + itemCode + ", itemName=" + itemName
				+ ", specs=" + specs + ", drugFlag=" + drugFlag
				+ ", classCode=" + classCode + ", feeCode=" + feeCode
				+ ", unitPrice=" + unitPrice + ", qty=" + qty + ", days="
				+ days + ", packQty=" + packQty + ", itemUnit=" + itemUnit
				+ ", ownCost=" + ownCost + ", payCost=" + payCost
				+ ", pubCost=" + pubCost + ", baseDose=" + baseDose
				+ ", selfMade=" + selfMade + ", drugQuanlity=" + drugQuanlity
				+ ", onceDose=" + onceDose + ", onceUnit=" + onceUnit
				+ ", doseModelCode=" + doseModelCode + ", frequencyCode="
				+ frequencyCode + ", usageCode=" + usageCode + ", execDpcd="
				+ execDpcd + ", mainDrug=" + mainDrug + ", combNo=" + combNo
				+ ", hypotest=" + hypotest + ", injectNumber=" + injectNumber
				+ ", remark=" + remark + ", doctCode=" + doctCode
				+ ", doctDpcd=" + doctDpcd + ", operDate=" + operDate
				+ ", status=" + status + ", cancelUserid=" + cancelUserid
				+ ", cancelDate=" + cancelDate + ", emcFlag=" + emcFlag
				+ ", labType=" + labType + ", checkBody=" + checkBody
				+ ", applyNo=" + applyNo + ", subtblFlag=" + subtblFlag
				+ ", needConfirm=" + needConfirm + ", confirmCode="
				+ confirmCode + ", confirmDept=" + confirmDept
				+ ", confirmDate=" + confirmDate + ", chargeFlag=" + chargeFlag
				+ ", chargeCode=" + chargeCode + ", chargeDate=" + chargeDate
				+ ", recipeNo=" + recipeNo + ", phamarcyCode=" + phamarcyCode
				+ ", minunitFlag=" + minunitFlag + ", dataorder=" + dataorder
				+ ", printFlag=" + printFlag + ", sequencenNo=" + sequencenNo
				+ ", recipeFeeseq=" + recipeFeeseq + ", recipeSeq=" + recipeSeq
				+ ", auditFlg=" + auditFlg + ", auditRemark=" + auditRemark
				+ ", regDeptName=" + regDeptName + ", className=" + className
				+ ", feeName=" + feeName + ", onceUnitName=" + onceUnitName
				+ ", doseModelName=" + doseModelName + ", frequencyName="
				+ frequencyName + ", usageName=" + usageName
				+ ", execDpcdName=" + execDpcdName + ", doctName=" + doctName
				+ ", doctDpcdName=" + doctDpcdName + "]";
	}
