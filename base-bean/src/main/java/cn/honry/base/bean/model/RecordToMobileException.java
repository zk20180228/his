 ...
 * @remark:用于平台异常信息的记录
 */
public class RecordToMobileException  implements java.io.Serializable {
	...
	public RecordToMobileException(){
	}
	/**
	 ...
	 * @param warnDate  告警时间
	 */
	public RecordToMobileException(String code,String codeName,String warnLevel,String warnType,Date warnDate){
		this.code=code;
	 ...
	 */
	public RecordToMobileException(String code,String codeName,String warnLevel,String warnType){
		this.code=code;
		this.warnLevel=warnLevel;
		this.warnType=warnType;
		this.codeName=codeName;
