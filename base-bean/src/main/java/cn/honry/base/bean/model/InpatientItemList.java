 ...
 * @version 1.0
 */
public class InpatientItemList extends Entity implements java.io.Serializable {
	...
	/** 报表字段 **/
	private List<InpatientItemList> inpatientItemList;

	public List<InpatientItemList> getInpatientItemList() {
		return inpatientItemList;
	}

	public void setInpatientItemList(List<InpatientItemList> inpatientItemList) {
		this.inpatientItemList = inpatientItemList;
	}
