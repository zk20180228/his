 ...
 * 结算召回模块
 */
public class InpatientBalanceHead extends Entity implements java.io.Serializable {
	...
	/**报表子报表**/
	private  List<InpatientBalanceHead> inpatientBalanceHead;
	/**医院编码**/
	...
	public List<InpatientBalanceHead> getInpatientBalanceHead() {
		return inpatientBalanceHead;
	}
	public void setInpatientBalanceHead(
			List<InpatientBalanceHead> inpatientBalanceHead) {
