 ...
 */
public class InpatientShiftApplyNow extends Entity implements Serializable {
	...
	public String getNewBenName() {
		return newBenName;
	}
	public void setNewBenName(String newBenName) {
		this.newBenName = newBenName;
	}
