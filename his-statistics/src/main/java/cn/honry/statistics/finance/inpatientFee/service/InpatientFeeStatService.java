package cn.honry.statistics.finance.inpatientFee.service;
...
public interface InpatientFeeStatService extends BaseService<InpatientInfo>{
	/**
	 * @Description: 获取患者信息
	 * @Author：  yeguanqun
	 * @CreateDate： 2016-6-2
	 ...
	 * @throws Exception 
	**/
	List<InpatientInfosVo> queryInpatientInfo(InpatientInfo inpatientInfoSerch, String a) throws Exception;
	/** 
	* @param a 
	 * @Title: queryMedicineList
	* @Description: 获取药品明细信息
	* @param @param inpatientNo
	* @param @return   
	* @return List<InpatientMedicineList>    
	 * @throws Exception 
	* @date 2016年6月6日下午7:06:13
	 */
	...
	* @date 2016年6月7日下午6:40:45
	 ...
	 * @Author：yeguanqun
	 * @param
	 * @CreateDate：2016-05-31 下午02:04:28  
	 * @ModifyRmk：  
	 * @version 1.0
	 * @throws Exception 
	 *
