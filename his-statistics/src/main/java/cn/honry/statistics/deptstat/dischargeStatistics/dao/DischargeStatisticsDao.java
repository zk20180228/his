package cn.honry.statistics.deptstat.dischargeStatistics.dao;

import java.util.List;

import cn.honry.statistics.deptstat.dischargeStatistics.vo.DischargeStatisticsVo;

public interface DischargeStatisticsDao {
	 ...
	 * @param deptCode 
	 */
	List<DischargeStatisticsVo> queryDischargeStatForDB(String startTime, String endTime, String deptCode, String page, String rows, String menuAlias);
