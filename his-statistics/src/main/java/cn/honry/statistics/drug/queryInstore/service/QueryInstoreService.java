package cn.honry.statistics.drug.queryInstore.service;
...
public interface QueryInstoreService extends BaseService<DrugInStore>{
	 ...
	 * @throws Exception 
	**/
	FileUtil export(List<DrugInStore> list, FileUtil fUtil) throws Exception;
	/**
	 * @Description:企业渲染
	 * @Description:
	 * @CreateDate: 2016年6月22日 
