...
public class DrugDispensSumVo {
	...
	/**报表**/
	private List<DrugDispensSumVo> drugDispensSumList; 
	
	public List<DrugDispensSumVo> getDrugDispensSumList() {
		return drugDispensSumList;
	}
	public void setDrugDispensSumList(List<DrugDispensSumVo> drugDispensSumList) {
		this.drugDispensSumList = drugDispensSumList;
	}
