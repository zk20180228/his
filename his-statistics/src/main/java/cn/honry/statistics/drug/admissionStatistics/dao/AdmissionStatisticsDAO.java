package cn.honry.statistics.drug.admissionStatistics.dao;
...
public interface AdmissionStatisticsDAO extends EntityDao<AdmissionStatisticsVo>{
	 ...
	 * @version: 1.0
	 */
	String getHql(String beginTime,String endTime,String deptCode,String storageCode,
