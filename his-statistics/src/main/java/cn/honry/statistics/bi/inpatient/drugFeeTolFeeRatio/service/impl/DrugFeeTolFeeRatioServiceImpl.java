package cn.honry.statistics.bi.inpatient.drugFeeTolFeeRatio.service.impl;
...
@Service("drugFeeTolFeeRatioService")
@Transactional
@SuppressWarnings({ "all" })
public class DrugFeeTolFeeRatioServiceImpl implements DrugFeeTolFeeRatioService{
	@Autowired
	@Qualifier(value = "drugFeeTolFeeRatioDAO")
	private DrugFeeTolFeeRatioDAO drugFeeTolFeeRatioDAO;
	...
	@Override
	public String queryDrugFeeTolFeeRatio(DateVo datevo, String[] dimStringArray,int dateType,String dimensionValue) {
		...
		String [] voArray=new String[]{"inpatientTolSum","inpatientFee","drugFee","otherFee","drugFeeRatio"};
		
		List<DrugFeeTolFeeRatioVo> volist=drugFeeTolFeeRatioDAO.queryDrugFeeTolFeeRatio(dimStringArray, list, dateType,datevo);
	...
	public List<BiBaseOrganization> queryDeptForBiPublic(String deptType) {
		return drugFeeTolFeeRatioDAO.queryDeptForBiPublic(deptType);
	}
}
