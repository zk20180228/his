package cn.honry.statistics.bi.inpatient.settlementAnalysis.dao;
...
public interface SettlementAnalysisDAO extends EntityDao<BiInpatientBalancehead>{
	/**
	 * 动态查询统计数据(住院费用分析统计)
	 * @author donghe 
	 ...
	 * @version 1.0
	 */
	List<ExpensesAnalyVO> querytSettlementDatagrid(String[] diArrayKey,
