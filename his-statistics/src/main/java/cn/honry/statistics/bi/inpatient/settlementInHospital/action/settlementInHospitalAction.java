package cn.honry.statistics.bi.inpatient.settlementInHospital.action;
...
@Namespace(value = "/statistics/settlementInHospital")
@SuppressWarnings({ "all" })
public class settlementInHospitalAction extends ActionSupport{
	@Autowired
    @Qualifier(value = "settlementInHospitalService")
	private SettlementInHospitalService settlementInHospitalService;
	public void setSettlementInHospitalService(
			SettlementInHospitalService settlementInHospitalService) {
		this.settlementInHospitalService = settlementInHospitalService;
	}
...
/************************************************************************************/
	 ...
	 * @version 1.0
	 */
	@Action(value = "settlementInHospitallist", results = { @Result(name = "list", location = "/WEB-INF/pages/stat/bi/inpatient/settlementInHospital/settlementInHospital.jsp") }, interceptorRefs = { @InterceptorRef(value = "manageInterceptor") })
	public String settlementInHospitallist() throws Exception {
		Date date=new Date();
	 ...
	 * @version 1.0 
	 */
	@Action(value="inHospitalDatagrid")
	public void inHospitalDatagrid(){
		...
		String resultData =settlementInHospitalService.querytInHospitalDatagrid(datevo,dimensionString,dateType,dimensionValue);
