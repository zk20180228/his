package cn.honry.statistics.bi.inpatient.settlementAnalysis.dao.impl;
...
@Repository("settlementAnalysisDAO")
@SuppressWarnings({"all"})
public class SettlementAnalysisDAOImpl extends HibernateEntityDao<BiInpatientBalancehead> implements SettlementAnalysisDAO{
	...
	@Override
	public List<ExpensesAnalyVO> querytSettlementDatagrid(String[] diArrayKey,
