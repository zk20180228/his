package cn.honry.statistics.bi.bistac.imStacData.dao;
...
public interface ImStacDataDao {
	/**
	 * 定时任务方法
	 * @Author zxh
	 * @time 2017年5月9日
	 ...
	 * @param endTime
	 */
//	public void imTableData_GHYSGZLDAY(String startTime, String endTime, List<String> tableList);
