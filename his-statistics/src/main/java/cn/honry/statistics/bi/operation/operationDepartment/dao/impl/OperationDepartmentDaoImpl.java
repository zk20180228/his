package cn.honry.statistics.bi.operation.operationDepartment.dao.impl;
...
@Repository("operationDepartmentDao")
public class OperationDepartmentDaoImpl implements OperationDepartmentDao {

	@Override
	public Map<String, Object> queryoperationPatientDept(String[] depts,
		...
		String mongoCollection="OPERATION_PC_DEPT_DAY"+begin+"|"+end;
