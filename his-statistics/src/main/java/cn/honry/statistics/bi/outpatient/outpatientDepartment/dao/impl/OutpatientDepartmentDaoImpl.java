package cn.honry.statistics.bi.outpatient.outpatientDepartment.dao.impl;
...
@Repository("outpatientDepartmentDao")
public class OutpatientDepartmentDaoImpl implements OutpatientDepartmentDao {
	...
	public Map<String, Object> queryOutPatientDept(String[] depts,
		...
		String mongoCollection="MZYS_DETAIL_DEPT_DAY"+begin+"|"+end;
