package cn.honry.statistics.bi.inpatient.expensesAnaly.dao;
...
public interface ExpensesAnalyDAO extends EntityDao<BiInpatientFeeinfo>{
	/**
	 * 动态查询统计数据(住院费用分析统计)
	 * @author donghe 
	 ...
	 * @version 1.0
	 */
	List<ExpensesAnalyVO> querytExpensesAnalyDatagrid(String [] diArrayKey,List<Map<String,List<String>>> list,int datetype,DateVo datevo );
}
