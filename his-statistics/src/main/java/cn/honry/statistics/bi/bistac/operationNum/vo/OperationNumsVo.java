package cn.honry.statistics.bi.bistac.operationNum.vo;

public class OperationNumsVo {
	...
	private Integer zyssNum;//住院手术例数
	private Integer mzssNum;//门诊手术例数
	...
	public Integer getZyssNum() {
		return zyssNum;
	}
	public void setZyssNum(Integer zyssNum) {
		this.zyssNum = zyssNum;
	}
	public Integer getMzssNum() {
		return mzssNum;
	}
	public void setMzssNum(Integer mzssNum) {
