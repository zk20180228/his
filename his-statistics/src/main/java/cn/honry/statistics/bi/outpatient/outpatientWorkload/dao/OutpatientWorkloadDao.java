package cn.honry.statistics.bi.outpatient.outpatientWorkload.dao;
...
public interface OutpatientWorkloadDao extends EntityDao<BiRegister>{
	/**
	 * 动态查询统计数据(门急诊工作量统计)
	 * @author tuchuanjiang
	 ...
	 * @version 1.0
	 */
	List<OutpatientWorkloadVo> querytWordloadDatagrid(String [] diArrayKey,List<Map<String,List<String>>> list,int datetype,DateVo datevo );
	/**
	 * 查询科室code、name
	 * @author tcj
	 * @return
